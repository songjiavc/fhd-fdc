Ext.define('FHD.view.icm.import.PracticeTestAssessPointImportPreviewGrid', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.practicetestassesspointimportpreviewgrid',
    
    url : __ctxPath + '/icm/process/import/findPracticeTestAssessPointPreviewListBySome.f',
    extraParams:{
    	fileId: ''
    },
    cols: [],
