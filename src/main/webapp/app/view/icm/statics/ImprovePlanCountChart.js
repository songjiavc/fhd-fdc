Ext.define('FHD.view.icm.statics.ImprovePlanCountChart', {
    extend: 'Ext.container.Container',
    alias: 'widget.improveplancountchart',
    border:false,
	url: __ctxPath + '/icm/statics/findimproveplancountbysome.f',
	toolRegion:'west',
	extraParams:{
		orgId:''
	},
    	...
    	me.chartPanel = Ext.create('FHD.view.comm.chart.ChartDashboardPanel',{
    		...
    		storeItem:[
	    	    ...
	    	    {'dataIndex':'createYear', 'header':'年份'},
	          	{'dataIndex':'improveName', 'header':'整改计划'},
	          	{'dataIndex':'defectDesc', 'header':'缺陷'}
        	],
        	//默认显示图表类型--可选
        	type:'msColumnChart',
        	//默认系列与图例选项--可选
        	xCol:{header:'年份',dataIndex:'createYear'},
    		yCol:{header:'缺陷',dataIndex:'defectDesc'},
    		//算法默认选项--可选
            methodType:'add',
    		//值选项--必选
        	valueCol:{header:'整改方案数量',dataIndex:'planCount'},
