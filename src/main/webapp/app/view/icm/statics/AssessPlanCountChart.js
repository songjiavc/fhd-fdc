Ext.define('FHD.view.icm.statics.AssessPlanCountChart', {
    extend: 'Ext.container.Container',
    alias: 'widget.assessplancountchart',
    border:false,
	url: __ctxPath + '/icm/statics/findassessplancountbysome.f',
	toolRegion:'west',
	extraParams:{
		orgId:''
	},
	initComponent: function() {
    	...
    	me.chartPanel = Ext.create('FHD.view.comm.chart.ChartDashboardPanel',{
            ...
            methodType:'add',
    		//值选项--必选
        	valueCol:{header:'评价计划数量',dataIndex:'planCount'},
