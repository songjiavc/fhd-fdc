Ext.define('FHD.view.icm.statics.ConstructPlanCountChart', {
    extend: 'Ext.container.Container',
    alias: 'widget.constructplancountchart',
    border:false,
	url: __ctxPath + '/icm/statics/findconstructplancountbysome.f',
	toolRegion:'west',
	extraParams:{
		orgId:''
	},
	initComponent: function() {
    	...
    	me.chartPanel = Ext.create('FHD.view.comm.chart.ChartDashboardPanel',{
    		...
    		//值选项--必选
        	valueCol:{header:'体系建设计划数量',dataIndex:'planCount'},
