Ext.define('FHD.view.icm.statics.AssessResultStaticsGrid', {
    ...
    initComponent: function() {
		 ...
		 me.gird = Ext.create('FHD.ux.GridPanel', {
			...
			cols: [
				...
				{ header: '流程节点', dataIndex: 'processPointName', flex: 1 ,hidden:true,
					renderer:function(value,metaData,record,colIndex,store,view) {
						metaData.tdAttr = 'data-qtip="'+value+'" '; 
						return value; 
					}
				},
				{ header: '控制措施', dataIndex: 'measureName', flex: 2,hidden:true,
					renderer:function(value,metaData,record,colIndex,store,view) {
						metaData.tdAttr = 'data-qtip="'+value+'" '; 
						return value; 
					}
				...
				{ header: '样本有效状态', dataIndex: 'isQualified', flex: 1,
					renderer:function(value,metaData,record,colIndex,store,view) {
						metaData.tdAttr = 'data-qtip="'+value+'" '; 
						return value; 
					}
		...
		me.add(me.assessresultcountchart);
        me.add(me.gird);
    },
    reloadData:function(orgid){
    	...
    	me.gird.store.load();
    	me.assessresultcountchart.extraParams = me.extraParams;
