Ext.define('FHD.view.icm.standard.StandardEditStepThree', {
    extend: 'Ext.container.Container',
    alias: 'widget.standardeditsteptree',
    requires: [
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
    		...
    		items:[
    			Ext.widget('panel',{border:false,items:Ext.widget('flowtaskbar',{
	    		jsonArray:[
		    		{index: 1, context:'1.申请更新',status:'done'},
		    		{index: 2, context:'2.申请审批',status:'done'},
		    		{index: 3, context:'3.反馈意见',status:'current'},
