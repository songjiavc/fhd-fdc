 ...
 * @author 邓广义
 */
Ext.define('FHD.view.icm.standard.StandardDetailsPopGrid',{
	extend : 'FHD.ux.GridPanel',
	alias: 'widget.standarddetailspopgrid',
	...
	turnTodealwith : function(){
		...
		me.standarddetailsturntodealwith = Ext.create('FHD.view.icm.standard.StandardDetailsTurnToDealwith',{recid:recid,processInstanceId:processInstanceId});
		var win = Ext.create('FHD.ux.Window',{
			...
			items:[me.standarddetailsturntodealwith],
			buttonAlign: 'center',
			listeners:{
				close:function(){
					me.reloadData();
	    ...
	    setstatus:function(){
	        ...
	        me.down('#icm_standarddetails_turn').setDisabled(!flag);
