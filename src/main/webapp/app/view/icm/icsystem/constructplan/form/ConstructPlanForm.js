...
//        };
        ...
        //组长
        me.constructPlanGroup = Ext.create('Ext.ux.form.OrgEmpSelect', {
        ...
        //组成员
        me.constructPlanGroupPers = Ext.create('Ext.ux.form.OrgEmpSelect', {
            ...
            items:[
                {
                    ...
                    collapsible : false,
                    title : '基本信息',
                    items : [//groupPersIdHid,groupLeaderIdHid,
                         constructPlanId,constructPlanCode,constructPlanName,constructPlanDateAmongCont,me.constructType,me.constructPlanGroup,me.constructPlanGroupPers
                    ]
                },
                {xtype : 'fieldset',
                    //margin: '7 10 0 30',
...
//                            'groupPersIdHid' : data.groupPersIdHid
//                        });
                        //给code表单赋值
                        if(me.executionId){
                        	me.initParam({
        	...
        	me.load({
                 ...
                 success: function (form, action) {
                	 ...
                	 if(action.result.data.groupLeaderId){
                		 me.constructPlanGroup.setValues(Ext.JSON.decode(action.result.data.groupLeaderId));
                	 }
                	 if(action.result.data.groupPersId){
                		 me.constructPlanGroupPers.setValues(Ext.JSON.decode(action.result.data.groupPersId));
                	 }
