    ...
    tbar: {
        ...
        items: [
	        ...
	        '<img src="'+__ctxPath+'/images/icons/show_right.gif">',
	        {
	            ...
	            action: 'icm_constructplan_card_range_btn_top',
	            handler: function () {
	            	var constructplancardpanel = this.up('constructplancardpanel');
	            	if(constructplancardpanel){
    ...
    bbar: {
        ...
        items: [
	        ...
	        {	
	            ...
	            action: 'icm_constructplan_card_undo_btn',
...
//	        },
	        {
	            ...
	            action: 'icm_constructplan_card_pre_btn' ,
	        ...
	        }, 
	        {
	            ...
	            action: 'icm_constructplan_card_next_btn' ,
	        ...
	        }, 
	        {
	            ...
	            action: 'icm_constructplan_card_finish_btn' ,
	        ...
	        }, 
	        {
	            ...
	            action: 'icm_constructplan_card_submit_btn' ,
    ...
    initComponent: function() {
        ...
        var btn = Ext.ComponentQuery.query('button[action=icm_constructplan_card_undo_btn]')[0]; 
        if(me.executionId){
...
//    		Ext.getCmp('icm_constructplan_card_close_btn').hidden=true;
    ...
    last:function(){
    	...
    	if(me.constructplanform.saveFunc(me)){
    		...
    		var btn = Ext.ComponentQuery.query('button[action=icm_constructplan_card_range_btn_top]')[0]; 
    ...
    submit:function(){
    	...
    	if(count == 0){
    		Ext.Msg.alert(FHD.locale.get('fhd.common.prompt'), '建设计划未选择建设范围!');
    		return;
		}
			    	...
			    	FHD.ajax({
				        ...
				        callback: function (data) {
				        	if(data){
						    	...
						    	Ext.ComponentQuery.query('button[action=icm_constructplan_card_pre_btn]')[0].setDisabled(true);
						        //Ext.getCmp('icm_constructplan_card_next_btn').setDisabled(true);
						        Ext.ComponentQuery.query('button[action=icm_constructplan_card_next_btn]')[0].setDisabled(true);
						       // Ext.getCmp('icm_constructplan_card_finish_btn').setDisabled(true);
						        ...
						        Ext.ComponentQuery.query('button[action=icm_constructplan_card_submit_btn]')[0].setDisabled(true);
    ...
    navBtnState:function(){
    	...
    	Ext.ComponentQuery.query('button[action=icm_constructplan_card_pre_btn]')[0].setDisabled(!layout.getPrev());
        //Ext.getCmp('icm_constructplan_card_next_btn' ).setDisabled(!layout.getNext());
        Ext.ComponentQuery.query('button[action=icm_constructplan_card_next_btn]')[0].setDisabled(!layout.getNext());
//        Ext.getCmp('icm_constructplan_card_finish_btn').setDisabled(!layout.getNext());
        ...
        Ext.ComponentQuery.query('button[action=icm_constructplan_card_submit_btn]')[0].setDisabled(!layout.getPrev());
    },
    /**
     * 设置导航按钮的选中或不选中状态
    ...
    setBtnState: function (index) {
        ...
        var topbar = Ext.ComponentQuery.query('toolbar[action=icm_constructplan_card_topbar]')[0]; 
    ...
    setNavBtnEnable:function(v,first){
    	...
    	if(first){
    		...
    		var btn1 = Ext.ComponentQuery.query('button[action=icm_constructplan_card_details_btn_top]')[0];
    		btn1.setDisabled(v);
