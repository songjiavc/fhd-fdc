Ext.define('FHD.view.icm.icsystem.constructplan.ConstructPlanDashboard', {
    ...
    initComponent: function() {
		...
		me.processChart = Ext.create('FHD.view.icm.statics.ConstructProcessCountChart',{
    		toolRegion:'west',
    		flex:4
    	});
        
        me.diagnosisChart =  Ext.create('FHD.view.icm.statics.DiagnosesCountChart',{
    		toolRegion:'west',
    		flex:4
    	});;
        ...
        me.constructPlanGrid = Ext.create('FHD.ux.GridPanel',{
			...
			cols : [
				...
				{header:'公司id', sortable: false,dataIndex: 'companyId', hidden:true},
