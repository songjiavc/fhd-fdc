...
Ext.define('FHD.view.icm.icsystem.form.RiskEditForm', {
    ...
    addComponent: function () {
    	var me = this;
    	//基本信息fieldset
        me.defineriskform = Ext.widget('riskshortform',{border : false,flex:1});
        me.add(me.defineriskform);
        // 流程id 隐藏域
    ...
    reloadData: function() {
        var me = this;
        me.defineriskform.reloadData(me.paramObj.processRiskId);
    },
    // 添加时, 初始化流程值
    initRiskForm: function(processId) {
        var me = this;
        me.defineriskform.getForm().setValues({
        	influProcessureName:processId
        });
    },
    // 初始化方法
