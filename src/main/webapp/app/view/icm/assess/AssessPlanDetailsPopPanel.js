 ...
 * @author 邓广义
 */
Ext.define('FHD.view.icm.assess.AssessPlanDetailsPopPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.assessplandetailspoppanel',
    requires: [
	    	...
	    	me.load({
		        url:me.queryUrl,
	   	        ...
	   	        success:function(form,action){
	   	        	...
	   	        	ass_container.assessplandetailspopgrid.reload_id = id;
	   	        	ass_container.assessplandetailspopgrid.reloadData();
