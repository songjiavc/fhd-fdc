...
Ext.define('FHD.view.icm.assess.component.AssessPlanRelaProcessEditGrid',{
	...
	initComponent:function(){
		...
		me.cols=[
			...
			{header : '一级流程分类',dataIndex : 'firstProcessName',sortable : false,hidden:true,
    			renderer : function(value, metaData, record, colIndex, store, view) {
					metaData.tdAttr = 'data-qtip="'+value+'"'; 
		 			return value;
				}
			},
			{header : '流程分类',dataIndex : 'parentProcessName',sortable : false,flex : 1,
    			renderer : function(value, metaData, record, colIndex, store, view) {
					metaData.tdAttr = 'data-qtip="'+value+'"'; 
		 			return value;
				}
			}, 
			{header : '流程',dataIndex :'processName',sortable : false, flex : 2,
    			renderer : function(value, metaData, record, colIndex, store, view) {
					metaData.tdAttr = 'data-qtip="'+value+'"'; 
		 			return value;
				}
			...
			{
				header : '是否穿行测试',dataIndex :'isPracticeTest',sortable : false, flex : 1, hidden:false,
    ...
    addAssessRelaProcess:function(){
    	...
    	//点击选择弹出框
    	var windows=Ext.create('FHD.ux.Window', {
    	    title:'选择流程',
    	    layout: 'column',
    	    columnWidth:1,
    	    //layout:'fit',
