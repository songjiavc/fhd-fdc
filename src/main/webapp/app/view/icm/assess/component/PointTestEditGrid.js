...
Ext.define('FHD.view.icm.assess.component.PointTestEditGrid',{
	...
	initComponent:function(){
		...
		me.cols=[
			{header:'操作', dataIndex: '',sortable: false,width:80, 
			...
			{header:'流程节点', dataIndex: 'processPointName', sortable: false,flex:2,hidden:true,
				renderer:function(value,metaData,record,colIndex,store,view) { 
				...
				renderer:function(value,metaData,record,colIndex,store,view) { 
					...
					if(record){
						...
						if(value){
							...
							metaData.tdAttr = 'data-qtip="如果需调整评价结果，请点击这里，否则，无需选择" style="background-color:#FFFBE6"';
						}
					}
				}
			},
			...
			{header:'缺陷描述', dataIndex: 'comment',sortable: false,flex:2,editor: {},
				renderer:function(value,metaData,record,colIndex,store,view) { 
					if(value){
						...
						metaData.tdAttr = 'data-qtip="如控制无效，请填写“缺陷描述”，否则，无需填写" style="background-color:#FFFBE6"';
					}
				}
			},
			{header:'影响程度', dataIndex: 'impact',sortable: false,width:80, 
				...
				renderer:function(value,metaData,record,colIndex,store,view) { 
					if(value){
						...
						metaData.tdAttr = 'data-qtip="如控制无效，请填写“影响程度”，为1~5之间的数，否则，无需填写" style="background-color:#FFFBE6"';
					}
				}
			},
