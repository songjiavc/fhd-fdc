 ...
 * */
 Ext.define('FHD.view.icm.assess.component.ProcessTestGrid',{
	...
	initComponent:function(){
		...
		Ext.apply(me,{
    		cols: [
    			{header:'操作(未测试数/总数)', dataIndex: 'do',sortable: false,width:300,
			    ...
			    {header:'流程分类', dataIndex: 'firstProcess', sortable: false,flex:2,hidden:true,
					renderer:function(value,metaData,record,colIndex,store,view) { 
						metaData.tdAttr = 'data-qtip="'+value+'"';
						return value;  
					}
				},
			    {header:'流程', dataIndex: 'name', sortable: false,flex:2,
					renderer:function(value,metaData,record,colIndex,store,view) { 
						metaData.tdAttr = 'data-qtip="'+value+'"';
						return value;  
					}
