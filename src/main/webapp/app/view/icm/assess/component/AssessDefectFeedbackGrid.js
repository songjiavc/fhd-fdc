	...
	initComponent:function(){
		...
		*/
		me.cols=[
			...
			{header:'流程', dataIndex: 'processName', sortable: false,flex:2,hidden:false,
				renderer:function(value,metaData,record,colIndex,store,view) { 
					metaData.tdAttr = 'data-qtip="'+value+'"';
					return value;  
				}
			...
			{header:'发生频率', dataIndex: 'probability',sortable: false,flex:2,
		    	renderer:function(value,metaData,record,colIndex,store,view) { 
		    		metaData.tdAttr = 'data-qtip="评价点的样本发生频率"';
					return value;
				}
		    },
		    {header:'影响程度', dataIndex: 'impact',sortable: false,flex:2,
		    	renderer:function(value,metaData,record,colIndex,store,view) { 
		...
		if (me.defectsIsAvailable) {
		    ...
		    me.colInsert(8, responsibilityOrg);
		    me.colInsert(9, defectDesc);
            me.colInsert(10, defectLevel);
            me.colInsert(11, defectType);
        }else{
		...
		if (me.feedbackIsAvailable) {
            ...
            me.colInsert(12, whetherOrNotPass);
            me.colInsert(13, feedback);
        }else{
        	var whetherOrNotPass = {
