Ext.define('FHD.view.icm.rectify.RectifyImproveDashboard', {
    ...
    initComponent: function() {
        ...
        var finishRateTitle;	//完成率不同，颜色不同
        if(me.finishRate<50){
        ...
        // 计划进度列表
        me.fhdgrid = Ext.create('FHD.ux.GridPanel',{
        	checked: false,
			searchable: true,
			pagable: true,
			flex: 4,
			margin: '1 1 1 1',
        	url:__ctxPath + '/icm/improve/findImproveListBypage.f', //调用后台url
        	extraParams:{
            	companyId:me.orgId,
            	dealStatus:'H,F'
            },
    ...
    generateChartXml:function(data,id){
    	...
    	*/
    	me.defectLevelChart = Ext.create('FHD.view.icm.statics.ImprovePlanCountChart',{
    		toolRegion:'west',
    		flex:4,
    		extraParams:{
    			orgId:me.orgId,
