			...
			items:[{
					...
					items:[{xtype: 'textfield', name: 'improvePlanId', hidden: true},
						...
						{xtype: 'displayfield',  columnWidth : 0.5, fieldLabel: '附&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;件', name : 'file', renderer : function(value,field) { 
						    	return "<a href=\"javascript:void(0);\" onclick=\"Ext.getCmp('"+me.id+"').downloadFile('"+field.up('form').down('[name=fileId]').value+"')\">"+value+"</a>";  
							}
						},
						...
						{xtype:'displayfield', columnWidth : 1, fieldLabel: '方案内容', name : 'content'}
					]
				}]
		});
