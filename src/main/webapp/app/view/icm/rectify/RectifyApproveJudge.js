		...
		Ext.apply(me,{
			...
			items:[Ext.widget('flowtaskbar',{
    	    	...
    	    	}),me.rectifyview, me.improveplanviewform,
    	    	{
    				...
    				title : '复核结果',
    				items:[
    				    {xtype:'displayfield', fieldLabel:'是否通过', name:'isPassName',columnWidth : 1/2},
					    ...
					    {xtype:'displayfield', fieldLabel:'下次观察日期', hidden:true, format:'Y-m-d', name:'nextCheckDate',columnWidth : 1/3},
	    				{
	    					...
	    					title : '整改结果',
	    					items:[ 
	    				       	{xtype:'displayfield', hideLabel:true,  readOnly:true, fieldLabel:'整改结果', name:'improveResult', rows:3}
	    					]
	    				},
	    				{
	    					xtype : 'fieldset',
	    					...
	    					items:[ 
	    						{xtype:'textfield', name:'improvePlanRelaDefectId', hidden:true},
	    				       	{xtype:'displayfield', hideLabel:true, readOnly:true, fieldLabel:'复核测试情况', name:'compensationControl'}
	    					]
	    				},{
	    					xtype : 'fieldset',
	    					layout : {
