Ext.define('FHD.view.response.responseplan.bpm.SolutionApplyFormForBpm', {
	extend:'Ext.panel.Panel',
	aligs:'widget.solutionapplyformforbpm',
	layout : {
		type : 'vbox',
		align : 'stretch'
	},
	requires: [
      ...
      'FHD.view.response.responseplan.bpm.SolutionApplyForm'
    ],
	autoScroll:true,
//	bodyPadding:'0 3 3 3',
	initComponent : function() {
		...
		me.flowtaskbar=Ext.widget('panel',{
        	...
        	items:[
	    		...
	    		jsonArray:[
		    		...
		    		{index: 2, context:'2.方案制定',status:'current'},
		...
		var solutionapplyform = Ext.widget('solutionapplyform',{flex:1});
		Ext.applyIf(me, {
        	items:[me.flowtaskbar,solutionapplyform]
		});
