Ext.define('FHD.view.response.workplan.workplanmake.WorkPlanRange', {
    extend: 'Ext.form.Panel',
    alias: 'widget.workPlanRange',
    requires: [
	],
    // 初始化方法
    initComponent: function() {
        ...
        me.rightgrid = Ext.create('FHD.view.response.workplan.workplanmake.WorkPlanDeptTakerGrid',{flex:1,margin:2,columnWidth :1,typeId: me.typeId});
