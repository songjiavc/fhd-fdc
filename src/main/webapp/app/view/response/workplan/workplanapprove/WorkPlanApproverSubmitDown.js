Ext.define('FHD.view.response.workplan.workplanapprove.WorkPlanApproverSubmitDown', {
    extend: 'Ext.form.Panel',
    alias: 'widget.workPlanApproverSubmitDown',
    ...
    initComponent: function() {
        ...
        me.downgrid = Ext.create('FHD.view.response.workplan.workplanapprove.WorkPlanApproverSubmitGridPanel',{
        	flex: 1,
        	margin: 2,
        	columnWidth: 1,
        	businessId: me.businessId
        });
        me.downgrid.reloadData(me.businessId);
