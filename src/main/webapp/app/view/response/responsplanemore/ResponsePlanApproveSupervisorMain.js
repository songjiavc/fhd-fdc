Ext.define('FHD.view.response.responsplanemore.ResponsePlanApproveSupervisorMain', {
	extend:'Ext.panel.Panel',
	aligs:'widget.responsePlanApproveSupervisorMain',
	requires: [
    ],
    border: false,
	//提交方法
		...
		Ext.MessageBox.show({
    		...
    		fn : function(btn) {
    			if (btn == 'yes') {//确认
					...
					FHD.ajax({//ajax调用
						url : __ctxPath+ '/responseplan/workflow/solutionplanapprovebysupervisor.f',
					    params : {
