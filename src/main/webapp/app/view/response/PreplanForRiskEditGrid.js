 ...
 * */
Ext.define('FHD.view.response.PreplanForRiskEditGrid',{
	extend:'FHD.ux.EditorGridPanel',
	alias: 'widget.preplanforriskeditgrid',
	...
	initComponent:function(){
		...
		me.cols=[
			...
			{
				header : '应对预案',dataIndex : 'solutionName',flex : 2,
...
//	    	selectedvalues:me.getGridStroe(),
    ...
    addPreplan : function(){
    	//2.按缺陷选择
    	var preplanform = Ext.widget('preplanform')
    	var win = Ext.create('FHD.ux.Window',{
			title:'填写应对预案',
			//modal:true,//是否模态窗口
			collapsible:false,
