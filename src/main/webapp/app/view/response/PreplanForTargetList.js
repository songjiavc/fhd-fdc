 ...
 * 针对指标的预案列表页面 
 * */
Ext.define('FHD.view.response.PreplanForTargetList',{
	extend: 'FHD.ux.GridPanel',
    alias: 'widget.preplanfortargetlist',
    requires: [
//    	'FHD.view.response.SolutionViewForm'
    ...
    initComponent: function(){
        ...
        me.cols = [
        	{header : '指标名称',dataIndex : 'targetName',sortable : false, flex : 2}, 
        ...
        me.tbarItems = [
        	{iconCls : 'icon-add',text: '添加',tooltip: '添加指标预案',handler :me.addPlan,scope : this},
			'-', 
			{iconCls : 'icon-edit',text: '修改',tooltip: '修改指标预案',handler :me.editPlan,disabled: true,scope : this},
			'-', 
			{iconCls : 'icon-del',text: '删除',tooltip: '删除指标预案',handler :me.delPlan,disabled: true,scope : this}
...
//        };
	...
	showMoreInfo : function(){ 
		var preplanviewform = Ext.widget('preplanviewform', {type: 'target'});
