 ...
 * 部门主管审批主页面
 */
Ext.define('FHD.view.response.major.scheme.approve.DeptApproveMainPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.deptapprovemainpanel',
    requires: [
	],
	//获得导航item
	getItems: function(){
		...
		me.flowtaskbarItem = Ext.create('FHD.ux.icm.common.FlowTaskBar',{
    		jsonArray:[
	    		...
	    		{index: 7, context:'7.部门主管审批',status:'current'},
    			...
    			if (btn == 'yes') {//确认
    				...
    				FHD.ajax({
    					...
    					params:{
    						...
    						approverKey:"leaderApproval"//部门领导审批代办key
    					},
    					async: false,
