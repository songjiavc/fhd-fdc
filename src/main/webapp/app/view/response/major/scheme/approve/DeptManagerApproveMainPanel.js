 ...
 * 部门主管审批主页面
 */
Ext.define('FHD.view.response.major.scheme.approve.DeptManagerApproveMainPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.deptmanagerapprovemainpanel',
    requires: [
	],
	//获得导航item
	getItems: function(){
    			...
    			if (btn == 'yes') {//确认
    				...
    				FHD.ajax({
    					...
    					params:{
    						...
    						approverKey:"officeApproval"//方案审批代办key
    					},
    					async: false,
