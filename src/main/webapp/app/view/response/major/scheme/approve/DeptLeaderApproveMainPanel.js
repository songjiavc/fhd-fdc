 ...
 * 部门主管审批主页面
 */
Ext.define('FHD.view.response.major.scheme.approve.DeptLeaderApproveMainPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.deptleaderapprovemainpanel',
    requires: [
	],
	//获得导航item
	getItems: function(){
		...
		me.flowtaskbarItem = Ext.create('FHD.ux.icm.common.FlowTaskBar',{
    		jsonArray:[
	    		...
	    		{index: 8, context:'8.部门领导审批',status:'current'},
    			...
    			if (btn == 'yes') {//确认
    				...
    				FHD.ajax({
    					...
    					params:{
    						...
    						approverKey:"managerApproval"//分管副总审批代办key
    					},
    					async: false,
