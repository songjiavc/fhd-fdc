 ...
 * 计划领导审批
 */
Ext.define('FHD.view.response.major.approve.MajorRiskPlanLeaderApproveMainPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.majorriskplanleaderapprovemainpanel',
    requires: [
	],
	//获得导航item
	getItems: function(){
    			...
    			if (btn == 'yes') {//确认
    				...
    				FHD.ajax({//ajax调用
					    ...
					    params : {
					    	...
					    	approverKey:"deptRiskManager"//计划领导审批
						},
