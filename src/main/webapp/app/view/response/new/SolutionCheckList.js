 ...
 * 方案列表页面 
 * */
Ext.define('FHD.view.response.new.SolutionCheckList',{
	extend: 'FHD.ux.GridPanel',
    alias: 'widget.solutionchecklist',
    requires: [
...
//        	{header : '风险名称',dataIndex : 'riskName',sortable : false, flex : 1}, 
    		{header : '方案编号',dataIndex : 'code',sortable : false, flex : 1}, 
 			...
 			{header : '实际开始日期',dataIndex : 'completeDate',sortable : false, flex : 1},
 			{header : '实际结束日期',dataIndex : 'completeDate',sortable : false, flex : 1},
    ...
    editPlan: function(button){
    	var solutionCheckEditForm = Ext.create('FHD.view.response.new.SolutionCheckEditForm');
