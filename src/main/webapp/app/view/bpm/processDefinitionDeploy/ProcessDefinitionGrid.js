    ...
    initComponent : function() {
        ...
        Ext.apply(me, {
    		...
    		cols : [
				...
				{dataIndex:'processDefinitionDeployId',invisible:true},
				{header: "流程定义名称",dataIndex: 'disName',sortable: true,flex:1},
				{header: "流程定义类型",dataIndex:'pdkey',sortable: true,flex:1},
			...
			/*默认排序方式*/
			storeSorters:[{property:'pdkey',direction:'asc'},{property:'pdversion',direction:'desc'}],
			/*工具栏*/
			tbarItems:tbarItems,
			listeners:listeners
        });
