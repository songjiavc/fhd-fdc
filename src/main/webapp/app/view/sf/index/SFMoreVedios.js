 ...
 * @author 郝静
 */
Ext.define('FHD.view.sf.index.SFMoreVedios', {
	...
	showMore:function(nodeId){
		var me = this;
		var url = 'FHD.view.sys.documentlib.DocumentLibMainPanel?document_library_case';
	    ...
	    if(tab){
			...
			if(url.startWith('FHD')){
				...
				myTask.documentLibCard.showDocumentLibGrid();//返回列表
				myTask.documentLibTree.clickTreeNode(nodeId,null);
