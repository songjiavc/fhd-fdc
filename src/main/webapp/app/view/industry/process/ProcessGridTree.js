...
Ext.define('FHD.view.industry.process.ProcessGridTree', {
    extend: 'FHD.ux.TreeGridPanel',
    alias: 'widget.processGridTree',
...
//    /***function end***/
    ...
    views : function(name){
//    	if(Ext.getCmp('processEditId').items.length != 0){
//    		Ext.getCmp('processEditId').removeAll();
//    	}
//    	
//    	
//    	Ext.getCmp('processEditId').setNumberValue('2323');
//    	Ext.getCmp('processEditId').setParentValue(name);
//    	Ext.getCmp('processEditId').setNameValue(name);
//    	
//    	Ext.getCmp('processEditId').setResponsibilityReValue('流程责任部门');
//    	Ext.getCmp('processEditId').setRelatedReValue('流程相关部门');
//    	Ext.getCmp('processEditId').setRelatedKpi();
//    	Ext.getCmp('processEditId').setRelatedRisk();
//    	Ext.getCmp('processEditId').doLayout();
    	
    	Ext.getCmp('industryCardId').processInfoTab.processEditContainer.items.items[0].load(name);
    	Ext.getCmp('industryCardId').showProcessInfoTab();
    },
...
//        me.url = 'test/queryTestMvcTree.f';
        ...
        me.tbars =[//菜单项
   			{text : '导入', iconCls: 'icon-ibm-move-left-disabled',id:'processImportId',
   	    		handler:function(){me.edit(me);}, scope : this},
       		{text : '导出', iconCls: 'icon-ibm-move-right-disabled',id:'processExportId',
   	    		handler:function(){me.edit(me);}, scope : this},
       		{text : '修改', iconCls: 'icon-edit',id:'processEditId',
   	    		handler:function(){me.edit(me);}, scope : this},
       		{text : '删除', iconCls: 'icon-del',id:'processDelId',
   	    		handler:function(){me.edit(me);}, scope : this}
   		];
