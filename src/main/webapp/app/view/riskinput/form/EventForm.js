 ...
 * 评价计划第一步：编辑页面
 */
Ext.define('FHD.view.input.form.EventForm',{
    ...
    initComponent : function() {
        ...
        me.bbar=['->',{
        		...
        		handler: function(){
    				...
    				eventeditcardpanel.navBtnHandler(0);
    				me.close();
                }
        	},'-',{
        ...
        var describe = {
 		...
 		var occurtime = Ext.widget('datefield', {
            xtype: 'datefield',
            format: 'Y-m-d',
            name: 'startDateStr',
            margin: '7 10 10 20',
        ...
        var reportStandard = Ext.create('Ext.form.CheckboxGroup', {
         	 fieldLabel:'符合上报标准',
    		 columnWidth:1,
    		 margin: '7 10 0 20',
    		 layout:{
...
//      --------------------------定量
        ...
        var percentageCon=Ext.create('Ext.container.Container',{
     	    ...
     	    margin: '20 10 0 0',
     	    columnWidth : 1,
     	    items:[percentage,percentageData,occurPossSel]
        });
        ...
        var partNumber = Ext.widget('textfield',{
        	name : 'partNumber',
        	fieldLabel : '零件号'
        });
        var orderNumber = Ext.widget('textfield',{
        	name : 'orderNumber',
        	fieldLabel : '订单号'
        });
        ...
        var reply = Ext.widget('dictradio', {
            ...
            margin: '20 10 0 20',
            dictTypeId: '0yn',
            fieldLabel: '是否为警情', //是否监控
            defaultValue: '0yn_y',
            labelAlign: 'left'
        });
        var replyPlan = Ext.widget('dictradio', {
            xtype: 'dictradio',
            labelWidth: 100,
            width:300,
            name: 'monitorStr',
...
//                    },
                    ...
                    title : '基本信息',
                    items : [
                         name,describe,occurtime,owndept,reportStandardCon,occurpossCon,effectDegreeCon,partNumber,orderNumber]
                },
                {xtype : 'fieldset',
                    //margin: '7 10 0 30',
//                    layout : {
