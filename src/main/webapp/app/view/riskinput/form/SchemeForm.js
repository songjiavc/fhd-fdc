...
//           width:1000,
        ...
        Ext.apply(me, {
            items: [ {
                    ...
                    title : '应对措施',
                    items : [
                          responsibleDeptCon,jobContent,jobType,finishtime,
                          Ext.widget('fieldcontainer',{margin: '7 10 0 20',layout : 'hbox',items : [{ xtype : 'numberfield',fieldLabel : '计划完成时间',name : 'date'},
        	     		  { xtype : 'label',text : '天内'}]}),
                          schemeFieldset,me.kpiFieldSet,kpiEtc,costCon]
                }
