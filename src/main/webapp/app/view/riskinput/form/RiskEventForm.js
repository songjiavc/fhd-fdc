...
//        var timeSelector = Ext.widget('timestampSelector');
        var occurtime = Ext.create('Ext.form.RadioGroup', {
        	     ...
        	     vertical: true,
        	     items: [
        	     		{ xtype : 'datefield',name : 'startdate'},
        	     		{ xtype : 'datefield',name : 'finishdate'},
        ...
        Ext.applyIf(me, {
            items:[
                ...
                {xtype : 'fieldset',
               	 ...
               	 title : '基本信息',
               	 items : [
               	 name,describe,occurtime,reportStandardCon,occurpossCon,effectDegreeCon,partNumber,orderNumber]
                },
                {xtype : 'fieldset',
                 collapsed : true,
                 collapsible : true,
