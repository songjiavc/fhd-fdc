 ...
 * 内控评价列表页面 
 * */
Ext.define('FHD.view.riskinput.RiskEventList',{
	extend: 'FHD.ux.GridPanel',
    alias: 'widget.riskeventlist',
    requires: [
    ...
    addPlan:function(){
    	...
    	me.kpiselectwindow =  Ext.create('FHD.ux.kpi.opt.KpiSelectorWindow',{
			    ...
			    onSubmit:function(store){
			    	var riskeventeditcardpanel = this.obj.up('riskeventeditcardpanel');
    ...
    editPlan: function(button){
    	...
    	var riskeventeditpanel = me.up('riskeventeditpanel');
    	if(riskeventeditpanel){
    		riskeventeditpanel.initParam({
    		editFlag : true,
