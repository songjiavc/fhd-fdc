Ext.define('FHD.view.risk.planconform.PlanConformGrid', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.planConformGrid',
 	requires: [
	],
    ...
    edit : function(isAdd){
    	...
    	if(isAdd){//添加按钮
    		 ...
    		 * 20170419
    		 * */
    		planEditOne.riskWorkSelect.setValue('secrecyRiskResponse');
    	}else{//修改
    ...
    initComponent: function() {
        ...
        Ext.apply(me,{
        	region:'center',
        	url : __ctxPath + "/access/planconform/findallplantypesgridpage.f?schm= "+ me.typeId,//查询列表url
        	cols:cols,
        	tbarItems:[{
        			btype:'add',
        			handler:function(){
