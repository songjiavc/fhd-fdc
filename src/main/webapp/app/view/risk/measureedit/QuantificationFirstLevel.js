...
//    },
	...
	initComponent: function() {
		...
		//定性
		//定量
		me.addKpiSetPlanBtn = Ext.widget('label',{
			html : "<a href='javascript:void(0)' onclick='Ext.getCmp(\""+me.id+"\").addQuantitative()'>设定区间/</a>"
        });
        me.addKpiLookPlanBtn = Ext.widget('label',{
			html : "<a href='javascript:void(0)' onclick='Ext.getCmp(\""+me.id+"\").addQuantitative()'>查看区间/</a>"
        });
		me.quantification = Ext.widget('kpioptselector', {
			name : 'kpiIds', 
			labelWidth : 80,
        ...
        var fieldcontainer1 = Ext.widget('fieldcontainer',{
        	...
        	me.addKpiSetPlanBtn,me.addKpiLookPlanBtn,me.delQuantification]
        }
        );
        var redLabel = {
			margin: '7 30 3 30',
