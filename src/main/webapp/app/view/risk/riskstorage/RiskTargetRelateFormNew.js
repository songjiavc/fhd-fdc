 ...
 * 风险-目标 form表单页面
 * 
 * @time 2017年3月22日15:20:28
 */
Ext.define('FHD.view.risk.riskstorage.RiskTargetRelateFormNew', {
    extend: 'Ext.form.Panel',
    alias: 'widget.risktargetrelateformnew',
    requires:[],
    //保存方法
    save: function() {
        var me = this;
        ...
        if (form.isValid() && me.customValidate()) {
            FHD.submit({
                ...
                callback : function(data) {
                    if(data.success){
                        me.up('risktargetcardnew').targetGrid.reloadData(null,'sm');
                        me.up('risktargetcardnew').showTargetGrid();
                    }
                }
            });
        }else{
