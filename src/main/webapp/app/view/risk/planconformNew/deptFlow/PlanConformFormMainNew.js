 ...
 * 整合计划制定入口
 */
Ext.define('FHD.view.risk.planconformNew.deptFlow.PlanConformFormMainNew',{
 	extend: 'Ext.form.Panel',
 	alias : 'widget.planConformFormMainNewDept',
 	border:false,
 	layout:{
		align: 'stretch',
		type: 'border'
    ...
    initComponent: function () {
    	...
    	var me = this;
    	//计划制定第一步
    	me.planConformEditOne = Ext.create('FHD.view.risk.planconformNew.deptFlow.PlanConformEditOneNew',{
		 	navigatorTitle:'计划制定',
		 	//计划类型           吉志强添加
		...
		me.planConformEditNext = Ext.create('FHD.view.risk.planconformNew.deptFlow.PlanConformEditNextNew',{
			 navigatorTitle:'范围选择',
			//2017年3月28日11:03:51 吉志强添加风险分库标识
			 schm :me.typeId,
			 planType:me.planType,
		...
		me.basicPanel = Ext.create('FHD.ux.layout.StepNavigator',{
			...
			btns: [me.btnSubmit],
		 	...
		 	undo : function(){
		 		...
		 		var cardPanel = me.up('planConformCardNewDept');
		 		setTimeout(function(){
