Ext.define('FHD.view.risk.planconformNew.deptFlow.PlanConformGridNew', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.planConformGridNewDept',
 	requires: [
	],
        ...
        var cols = [
			...
			},
	        {
	            ...
	            renderer:function(dataIndex) { 
    				  if(dataIndex == "riskAssessDept"){
    					  return '部门风险评估';
    				  }else if(dataIndex == "riskIdentifyDept"){
    					  return "部门风险辨识";
    				  }
    				  else{
    				  	return '';
