 ...
 */
Ext.define('FHD.view.risk.planconformNew.deptFlow.PlanConformEditNextGridNew',{
	extend:'FHD.ux.EditorGridPanel',
	alias: 'widget.planConformEditNextGridNewDept',
	requires: [
    ],
    //传参方法
    submitPlanByParams: function(approverId,businessId,value){
		...
		var args = {
			...
			executionId: '',
			entityType: 'riskAssessTotalDept',//2017年4月27日09:50:24 吉志强 部门风险评估流程id
...
//		console.log("args:="+JSON.stringify(args));
	...
	risksSelect:function(){
    	...
    	var typeId = me.up('planConformFormMainNewDept').planConformEditOne.riskWorkSelect.getValue();// 取流程类型
...
//									this.store.proxy.url = __ctxPath + '/access/formulateplan/findempsbydeptids.f';
									//2017年4月7日14:05:29 吉志强获取部门风险管理员 （即承办人）
									this.store.proxy.url = __ctxPath + '/access/formulateplan/findempsbydeptidsNew.f?roleCode=DeptRiskManager';
