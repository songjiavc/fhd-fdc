...
Ext.define('FHD.view.risk.planconformNew.deptFlow.PlanConformEditOneNew', {
    extend: 'Ext.form.Panel',
    alias: 'widget.planConformEditOneNewDept',
    requires: [
	...
	workFlowLisener: function(combo,records,eOpts){
		var me = this;
		if('riskAssessDept'==records[0].data.type){//部门风险评估计划
			me.loadMbsStore();
...
//        alert("schm:"+me.schm)
        ...
        me.fieldSet = {
            ...
            layout: {
     	    ...
     	    items : [me.planName,planCode, autoButton, me.reponser, me.contactor, me.planType, me.assessPlanTime,
