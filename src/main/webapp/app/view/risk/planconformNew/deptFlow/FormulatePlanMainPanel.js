...
Ext.define('FHD.view.risk.planconformNew.deptFlow.FormulatePlanMainPanel',{
 	extend: 'Ext.form.Panel',
 	alias : 'widget.formulateplanmainpanelDept',
 	border:false,
 	layout:{
	    		align: 'stretch',
	    		type: 'vbox'
    ...
    initComponent: function () {
    	...
    	var planEdit_saveUrl = 'access/formulateplan/saveriskplanNew.f';//保存计划制定表单url
...
//    		 		formulateDeptUndertakerGrid.flowType = "dept";
    		 		if(form.isValid()){
