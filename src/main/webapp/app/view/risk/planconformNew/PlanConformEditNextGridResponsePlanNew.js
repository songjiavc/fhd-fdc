/**
 * 评估范围fieldSet，部门承办人列表--风险应对
 */
Ext.define('FHD.view.risk.planconformNew.PlanConformEditNextGridResponsePlanNew',{
	extend:'FHD.ux.EditorGridPanel',
	alias: 'widget.planConformEditNextGridResponsePlanNew',
	requires: [
    ],
    //传参方法
