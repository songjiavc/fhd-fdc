Ext.define('FHD.view.risk.planconformNew.PlanRisksPreviewGridNew', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.planRisksPreviewGridNew',
    requires: [
    ],
	//加载列表数据   
    ...
    //弹出风险详细信息组件
    showRiskWindow: function(objectId){
    	var me = this;
        ...
        me.cols = [ {dataIndex : 'id', hidden : true}, 
                    ...
                    {header : "风险名称", dataIndex : 'riskName', sortable : true, flex : 3,
						...
						listeners:{
			        		click:{
			        			fn:function(g,d,i){
			        				var objectId = g.getStore().getAt(i).data.scoreObjId;
			        				me.showRiskWindow(objectId);
		        				}
        					}
        				}},
