Ext.define('FHD.view.risk.contingencyPlan.presidentApprove.PresidentApproveMain', {
    			...
    			if (btn == 'yes') {//确认
					...
					FHD.ajax({//ajax调用
					    ...
					    params : {
					    	...
					    	approverKeyType : 'approveManyToOne',
					    	totalExecutionId : me.totalExecutionId,//主流程ID，为了存储审批人
