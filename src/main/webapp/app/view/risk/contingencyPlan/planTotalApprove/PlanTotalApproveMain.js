Ext.define('FHD.view.risk.contingencyPlan.planTotalApprove.PlanTotalApproveMain', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.plantotalapprovemain',
...
//			region: 'north',
			...
			items:Ext.create('FHD.ux.icm.common.FlowTaskBar',{
	    		jsonArray:[
		    		...
		    		{index: 13, context:'13.业务分总审批',status:'current'},
