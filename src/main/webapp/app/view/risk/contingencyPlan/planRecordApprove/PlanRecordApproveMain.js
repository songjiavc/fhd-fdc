Ext.define('FHD.view.risk.contingencyPlan.planRecordApprove.PlanRecordApproveMain', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.planRecordApproveMain',
...
//			region: 'north',
			...
			items:Ext.create('FHD.ux.icm.common.FlowTaskBar',{
	    		jsonArray:[
		    		...
		    		{index: 10, context:'10.预案汇总整理',status:'done'},
		    		{index: 11, context:'11.风险部门主管审批',status:'done'},
		    		{index: 12, context:'12.风险部门领导审批',status:'done'},
		    		{index: 13, context:'13.业务分总审批',status:'done'},
		    		{index: 14, context:'14.备案',status:'current'}
		    	],
		    	margin : '5 5 5 5'
    	})});
