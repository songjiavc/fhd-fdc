Ext.define('FHD.view.risk.contingencyPlan.planCollectApprove.PlanCollectTidyTreePanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.plancollecttidytreepanel',
    ...
    initComponent: function() {
        ...
        var riskTreeUrl = __ctxPath + '/access/riskidentify/getrisktreerecordbyeventids.f?assessPlanId=' + me.assessPlanId;
