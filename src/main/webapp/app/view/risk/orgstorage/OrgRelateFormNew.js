 ...
 * @author
 */
Ext.define('FHD.view.risk.orgstorage.OrgRelateFormNew', {
    extend: 'Ext.form.Panel',
    alias: 'widget.orgrelateformnew',
    requires:[],
        ...
        if (form.isValid() && me.customValidate()) {
            FHD.submit({
                ...
                callback : function(data) {
                    if(data.success){
                        me.up('orgstoragecardnew').riskGrid.reloadData(me.riskId,'org');
                        me.up('orgstoragecardnew').showRiskGrid();
                    }
                }
            });
        }else{
            ...
            FHD.submit({
                ...
                callback : function(data) {
                    if(data.success){
                        ...
                        me.up('orgstoragecardnew').riskGrid.reloadData(id,'org');
                        me.up('orgstoragecardnew').showRiskGrid();
                    }
                }
            });
