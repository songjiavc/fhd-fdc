Ext.define('FHD.view.risk.orgstorage.OrgEventGridNew', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.orgeventgridnew',
    requires: [
    ...
    addFun: function () {
        var me = this;
        me.up('orgstoragecardnew').riskRelateForm.resetData();
        me.up('orgstoragecardnew').showRiskRelateForm();
    },
    ...
    editFun: function () {
        ...
        //切换到风险事件添加card
        me.up('orgstoragecardnew').riskRelateForm.reloadData(id);
        me.up('orgstoragecardnew').showRiskRelateForm();
    },
