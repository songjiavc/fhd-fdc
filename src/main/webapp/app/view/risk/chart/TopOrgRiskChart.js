Ext.define('FHD.view.risk.chart.TopOrgRiskChart', {
    extend: 'Ext.container.Container',
    alias: 'widget.toporgriskchart',
    
    border:false,
    toolRegion:'west',
    url: __ctxPath + '/app/view/risk/chart/data/topOrgRiskDataJson.json',
	extraParams:{
		orgId:''
	},
	//默认显示图表类型--可选
	...
	//默认系列与图例选项--可选
	myXCol:{header:'部门',dataIndex:'orgName'},
      	...
      	me.chartPanel = Ext.create('FHD.view.comm.chart.ChartDashboardPanel',{
      		...
      		storeItem:[
  	    	    {'dataIndex':'', 'header':'请选择'},
  	      	    {'dataIndex':'parentName', 'header':'部门'},
