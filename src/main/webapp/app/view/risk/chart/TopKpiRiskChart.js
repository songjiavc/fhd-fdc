Ext.define('FHD.view.risk.chart.TopKpiRiskChart', {
    extend: 'Ext.container.Container',
    alias: 'widget.topkpiriskchart',
    
    border:false,
    toolRegion:'west',
    url: __ctxPath + '/app/view/risk/chart/data/topKpiRiskDataJson.json',
	extraParams:{
		orgId:''
	},
	//默认显示图表类型--可选
	...
	//默认系列与图例选项--可选
	myXCol:{header:'指标',dataIndex:'kpiName'},
