Ext.define('FHD.view.risk.processStorage.ProcessEventGridNew', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.processeventgridnew',
    requires: [
    ...
    addFun: function () {
        var me = this;
        me.up('processstoragecardnew').processRelateForm.resetData();
        me.up('processstoragecardnew').showRiskRelateForm();
    },
    ...
    editFun: function () {
        ...
        //切换到风险事件添加card
        me.up('processstoragecardnew').riskRelateForm.reloadData(id);
        me.up('processstoragecardnew').showRiskRelateForm();
    },
