Ext.define('FHD.view.risk.riskidentify.identifyapprove.IdentifyApproveTwoMain', {
    extend: 'Ext.form.Panel',
    alias: 'widget.identifyApproveTwoMain',
    requires: [
	],
	//提交方法
		...
		Ext.MessageBox.show({
    		...
    		fn : function(btn) {
    			if (btn == 'yes') {//确认
					...
					FHD.ajax({//ajax调用
						url : __ctxPath+ '/access/riskidentify/submitidentifyapprovetwo.f',
					    params : {
