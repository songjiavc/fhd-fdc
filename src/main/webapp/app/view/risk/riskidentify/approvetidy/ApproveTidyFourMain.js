	/**
	 * @author 宋佳
	 * @modifytime 2017-7-29
	 */
	Ext.define('FHD.view.risk.riskidentify.approvetidy.ApproveTidyFourMain', {
	    extend: 'Ext.form.Panel',
	    alias: 'widget.approveTidyFourMain',
	    requires: [
		],
		//提交方法
			...
			Ext.MessageBox.show({
	    		...
	    		fn : function(btn) {
	    			if (btn == 'yes') {//确认
						...
						FHD.ajax({//ajax调用
							url : __ctxPath+ '/access/riskidentify/submitidentifyapprovefour.f',
						    params : {
