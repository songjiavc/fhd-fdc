Ext.define('FHD.view.risk.riskidentify.approve.RiskIdentifyApproveDown', {
    extend: 'Ext.form.Panel',
    alias: 'widget.riskIdentifyApproveDown',
    ...
    initComponent: function() {
        ...
        me.downgrid = Ext.create('FHD.view.risk.riskidentify.approve.RiskIdentifyApproveGrid',{
        	flex: 1,
        	margin: 2,
        	columnWidth: 1,
