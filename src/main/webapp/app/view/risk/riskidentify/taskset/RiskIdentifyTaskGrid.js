Ext.define('FHD.view.risk.riskidentify.taskset.RiskIdentifyTaskGrid', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.riskIdentifyTaskGrid',
    requires: [
	],
    ...
    riskTaskWindow: function(){
    	...
    	me.riskIdentifyTaskByRisk = Ext.create('FHD.view.risk.riskidentify.taskset.RiskIdentifyTaskByRisk');
    	me.riskIdentifyTaskByRisk.loadData(riskIdArray.join(','));
    	...
    	me.riskWin = Ext.create('FHD.ux.Window', {
    		...
    		width: 600,
   			layout: 'fit',
   			buttonAlign: 'center',
    		items: [me.riskIdentifyTaskByRisk],
   			fbar: [
   					{ xtype: 'button', text: '保存', handler:function(){me.winConfirm(me.riskIdentifyTaskByRisk);}},
...
//			sortable : false
//		},
		{header:'辨识人<font color=red>*</font>',dataIndex:'empId',flex:2,
