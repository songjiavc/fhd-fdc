 ...
 * @author 张健
 */
Ext.define('FHD.view.risk.cmp.container.analyse.AnalyseOrgContainer', {
    extend: 'FHD.ux.CardPanel',
    alias: 'widget.analyseorgcontainer',
    ...
    initComponent: function () {
        ...
        var treeArr = [];
        //图表分析
        if($ifAnyGranted('ROLE_ALL_ASSESS_ANALYSIS_RISKQUERY_ORG_CHART')){
        ...
        //风险事件列表页
        if($ifAnyGranted('ROLE_ALL_ASSESS_ANALYSIS_RISKQUERY_ORG_RISKLIST')){
        ...
        //历史记录页
        if($ifAnyGranted('ROLE_ALL_ASSESS_ANALYSIS_RISKQUERY_ORG_HISTORY')){
