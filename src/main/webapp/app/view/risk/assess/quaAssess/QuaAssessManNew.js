...
Ext.define('FHD.view.risk.assess.quaAssess.QuaAssessManNew', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.quaAssessManNew',

	requires : [ 
	        'FHD.view.risk.assess.quaAssess.QuaAssessPanelNew',
		...
		FHD.ajax({
            ...
            callback: function (data) {
                if (data && data.success) {
                	...
                	me.quaAssessPanel = Ext.widget('quaAssessPanelNew', {
            			executionId : me.executionId,
