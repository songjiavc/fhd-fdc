Ext.define('FHD.view.risk.assess.newAgainRiskTidy.treeGrid.RiskTreeGrid', {
	extend : 'FHD.ux.TreeGridPanel',
	alias : 'widget.riskTreeGrid',
	requires : [],
    ...
    exportGrid: function(businessId){
    	...
    	window.location.href = __ctxPath + "/assess/riskTidy/exportriskcountgrid.f?businessId="+businessId+"&exportFileName="
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			url : __ctxPath + "/assess/riskTidy/riskcountgrid.f?assessPlanId="+me.riskTidyMan.businessId,// 查询列表url
			cols: cols,
			useArrows : true,
			rootVisible : false,
			multiSelect : true,
