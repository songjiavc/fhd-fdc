...
Ext.define('FHD.view.risk.assess.newAgainRiskTidy.AssessTreeForSecurity', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.assesstreeforsecurity',
    ...
    sets : function(typeId, type){
    	...
    	me.riskTidyMan.riskTidyTab.riskAssessGrid.store.proxy.extraParams = extraParams;
...
//    	me.processTree.store.load();
    ...
    initComponent: function() {
        ...
        var riskTreeUrl = __ctxPath + '/potentialRiskEvent/getRiskTreeRecordByEventIdsForSecurity?assessPlanId=' + me.assessPlanId;
