...
Ext.define('FHD.view.risk.assess.newAgainRiskTidy.NewRiskTidyMan', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.newRiskTidyMan',
    
    requires: [
    	 		'FHD.view.risk.assess.newAgainRiskTidy.RiskTidyTab',
               'FHD.view.risk.assess.newAgainRiskTidy.NewAssessTree',
               'FHD.view.risk.assess.newAgainRiskTidy.NewRiskTidyCard',
        	...
        	FHD.ajax({
                ...
                callback: function (data) {
                    if (data && data.success) {
                    	...
                    	me.riskTidyTab = Ext.widget('riskTidyTab',{riskTidyMan : me});
                    	me.assessTree = Ext.widget("newAssessTree",{extraRiskParams : riskRbsOrReListMap, region:'west',schm : me.schm,
