Ext.define('FHD.view.risk.assess.newAgainRiskTidy.treeGrid.OrgTreeGrid', {
    ...
    exportGrid: function(businessId){
    	...
    	window.location.href = __ctxPath + "/assess/riskTidy/exportorgcountgrid.f?businessId="+businessId+"&exportFileName="
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			url : __ctxPath + "/assess/riskTidy/organizationcountgrid.f?assessPlanId="+me.riskTidyMan.businessId,// 查询列表url
			cols: cols,
			useArrows : true,
			rootVisible : false,
			multiSelect : true,
