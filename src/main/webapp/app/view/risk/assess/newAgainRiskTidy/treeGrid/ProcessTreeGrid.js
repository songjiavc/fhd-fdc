Ext.define('FHD.view.risk.assess.newAgainRiskTidy.treeGrid.ProcessTreeGrid', {
	extend : 'FHD.ux.TreeGridPanel',
	alias : 'widget.processTreeGrid',
	requires : [],
		...
		Ext.Ajax.request({
		    ...
		    success: function(response){
				...
				/*me.quaAssessEdit.on('resize',function(p){
		        	me.quaAssessEdit.detailAllForm.setHeight(me.formwindow.getHeight()-20);
		        	me.quaAssessEdit.setHeight(me.formwindow.getHeight()-20);
			   	});*/
    ...
    exportGrid: function(businessId){
    	...
    	window.location.href = __ctxPath + "/assess/riskTidy/exportprocesscountgrid.f?businessId="+businessId+"&exportFileName="
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			url : __ctxPath + "/assess/riskTidy/processcountgrid.f?assessPlanId="+me.riskTidyMan.businessId,// 查询列表url
			cols: cols,
			useArrows : true,
			rootVisible : false,
			multiSelect : true,
