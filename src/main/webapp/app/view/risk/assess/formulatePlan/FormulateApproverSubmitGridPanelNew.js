/*
 * 2017年4月12日16:06:52 当风险评估流程走到计划主管审批时，查看明细，添加删除没有用(删掉)   吉志强
 */

Ext.define('FHD.view.risk.assess.formulatePlan.FormulateApproverSubmitGridPanelNew', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.formulateApproverSubmitGridPanelNew',
    requires: [
	...
	seeRisksInfoByDeptId: function(seeAll){
		...
		//2017年4月12日16:07:45 吉志强修改        //////////////////////   begin //////////////////////
		formulatePlanPreviewGrid.down("[name='risk_grid_add']").setDisabled(true);
		formulatePlanPreviewGrid.down("[name='risk_grid_add']").setVisible(false);
		formulatePlanPreviewGrid.down("[name='risk_grid_delete']").setDisabled(true);
		formulatePlanPreviewGrid.down("[name='risk_grid_delete']").setVisible(false);
		//2017年4月12日16:07:45 吉志强修改        //////////////////////   end //////////////////////
