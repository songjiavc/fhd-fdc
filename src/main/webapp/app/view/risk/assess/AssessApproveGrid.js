...
Ext.define('FHD.view.risk.assess.AssessApproveGrid', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.assessApproveGrid',
    
    requires : [ 'FHD.view.risk.assess.utils.DeptLeadIdea'],
    
    riskDatas : null,
    
    edit : function(scoreObjectId, riskId){
    	var me = this;
    	me.quaAssessEdit = Ext.widget('deptLeadIdea');
