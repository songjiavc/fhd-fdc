    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
        	...
        	html : 
        		...
        		'<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/risk/join.gif" style="vertical-align:middle; margin-right:5px">' +
        		'<img src="images/risk/layer-small.png" style="vertical-align:middle; margin-right:5px"><a href="javascript:Ext.getCmp(\'indexNavId\').onMenuClick(\'FHD.view.risk.assess.report.RiskAssessReportLeaderView\',\'定性评估\');">定性评估</a><br><br><br><br>' +
        		'<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/risk/join.gif" style="vertical-align:middle; margin-right:5px">' +
        		...
        		'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000" ><img src="images/risk/book-open-list.png" style="vertical-align:middle; margin-right:5px"><a href="javascript:Ext.getCmp(\'indexNavId\').onMenuClick(\'FHD.view.risk.assess.report.RiskAssessReportTemplateMain\',\'报告模板\');">风险评估报告</a></font>' +
        		...
        		'<a href="javascript:Ext.getCmp(\'indexNavId\').onMenuClick(\'FHD.view.risk.assess.report.RiskAssessReport\',\'报告模板\');">2013年度第二季度风险评估报告<font color="#FF0000">（新）</font></a></font>' +
        		'<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000" ><img src="images/risk/join.gif" style="vertical-align:middle; margin-right:5px">' +
        		'<img src="images/risk/layer-small.png" style="vertical-align:middle; margin-right:5px">' +
