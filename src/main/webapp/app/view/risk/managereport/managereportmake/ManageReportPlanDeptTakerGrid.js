 ...
 */
Ext.define('FHD.view.risk.managereport.managereportmake.ManageReportPlanDeptTakerGrid',{
	extend:'FHD.ux.EditorGridPanel',
	alias: 'widget.managereportplandepttakergrid',
	requires: [
		...
		me.win = Ext.create('FHD.view.risk.cmp.riskevent.RiskEventSelectorWindow',{//风险选择组件
    		...
    		showLight: true,
		   	onSubmit:function(win){
		   		var managereportplanmakeeditmain = me.up('managereportplanmakeeditmain');
				var planId = managereportplanmakeeditmain.businessId;
    ...
    seeRisksInfoByDeptId: function(seeAll){
    	...
    	var me = this;
    	var managereportplanmakeeditmain = me.up('managereportplanmakeeditmain');
		var planId = managereportplanmakeeditmain.businessId;//计划id
