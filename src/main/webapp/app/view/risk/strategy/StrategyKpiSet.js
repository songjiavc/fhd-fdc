Ext.define('FHD.view.risk.strategy.StrategyKpiSet', {
    extend: 'FHD.ux.EditorGridPanel',
    alias: 'widget.strategykpiset',
    ...
    tbarItems: [{
        ...
        handler: function () {
            //弹出指标选择按钮
            Ext.getCmp('strategykpiset').popKpiSelectorWindow();
        }
    }],
    border: false,
    pagable: false,
                ...
                callback: function (ret) {
                    if (ret && ret.success) {
                        ...
                        if (!finishflag) {
                            ...
                            Ext.getCmp('risk_sm_alarmset_btn' ).setDisabled(false);
                            Ext.getCmp('risk_sm_alarmset_btn_top' ).setDisabled(false);
                        }else{
