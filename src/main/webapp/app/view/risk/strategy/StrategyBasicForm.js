Ext.define('FHD.view.risk.strategy.StrategyBasicForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.strategybasicform',
    border: false,
                    ...
                    FHD.submit({
                        ...
                        callback: function (data) {
                            if (data) {
                                ...
                                Ext.getCmp('strategymainpanel').paramObj.smid = data.smId;//图表使用
                                ...
                                if(!finishflag){
                                    ...
                                    //同时将衡量指标按钮变为激活状态
                                    Ext.getCmp('risk_sm_kpiset_btn').setDisabled(false);
                                    Ext.getCmp('risk_sm_kpiset_btn_top').setDisabled(false);
                                }else{
                                	strategyobjectivecardpanel.gotopage();
                                }
                                
                                if(!editflag){//添加节点
                                	var strategyobjectivetree = Ext.getCmp('strategyTreePanel');
                                    var node = {id:me.paramObj.smid,text:me.paramObj.smname,dbid:me.paramObj.smid,leaf:true,type:'sm'};
                                    ...
                                    //刷新导航
                                    Ext.getCmp('strategymainpanel').navigationBar.renderHtml('smtabcontainer', me.paramObj.smid, '', 'sm');
                                  }else{//编辑节点
                                  	//需要替换节点名称
                                  }
    ...
    addComponent: function () {
        ...
        //所属部门人员
        var ownDept = Ext.create('FHD.ux.org.CommonSelector', {
        ...
        //查看人
        var viewDept = Ext.create('FHD.ux.org.CommonSelector', {
        ...
        //报告人
        var reportDept = Ext.create('FHD.ux.org.CommonSelector', {
