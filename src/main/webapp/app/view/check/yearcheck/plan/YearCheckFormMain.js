 ...
 * 年度考核计划发起入口
 */
Ext.define('FHD.view.check.yearcheck.plan.YearCheckFormMain',{
 	extend: 'Ext.form.Panel',
 	alias : 'widget.yearCheckFormMain',
 	border:false,
 	layout:{
		align: 'stretch',
		type: 'border'
    ...
    initComponent: function () {
    	var me = this;
    	//计划制定第一步
    	me.yearCheckPlanFormOne = Ext.create('FHD.view.check.yearcheck.plan.YearCheckPlanFormOne',{
		 	navigatorTitle:'计划制定',
		 	border: false,
		 	last:function(){//保存计划
    		 	...
    		 	if(form.isValid()){
    		 		FHD.submit({
						form:form,
						url: __ctxPath + '/check/yearcheck/savaYearCheckPlan.s',
						callback:function(data){
