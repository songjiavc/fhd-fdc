Ext.define('FHD.view.check.yearcheck.plan.YearCheckPlanGrid', {
    extend: 'FHD.ux.GridPanel',
    alias: 'widget.yearCheckPlanGrid',
 	requires: [
	],
	
    edit : function(isAdd){
    	var me = this;
    	var cardPanel = me.up('yearcheckcard');
    	var planEditOne = cardPanel.yearCheckFormMain.yearCheckPlanFormOne;
    	if(isAdd){//添加按钮
    	...
    	cardPanel.showyearCheckFormMain();
    },
    //预览窗口
    	...
    	Ext.MessageBox.show({
    		...
    		fn : function(btn) {
    			if (btn == 'yes') {//确认删除
    				...
    				FHD.ajax({//ajax调用
    					url : __ctxPath + '/check/yearcheck/deleteYearPlan.d',
    					params : {
    						id:ids.join(',')
    					},
    ...
    initComponent: function() {
        ...
        Ext.apply(me,{
        	region:'center',
        	url : __ctxPath + "/check/yearcheck/findAllPlans.f",//查询列表url
        	cols:cols,
        	tbarItems:[{
        			btype:'add',
        			handler:function(){
