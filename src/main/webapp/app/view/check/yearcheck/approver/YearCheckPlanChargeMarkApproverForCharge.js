...
Ext.define('FHD.view.check.yearcheck.approver.YearCheckPlanChargeMarkApproverForCharge', {
    extend: 'Ext.form.Panel',
    alias: 'widget.yearCheckPlanChargeMarkApproverForCharge',
	...
	var me=this;
		...
		FHD.ajax({//ajax调用
			url : __ctxPath+ '/check/yearcheck/submAuditMarkForCharge.s',
		    params : {
		    	businessId:me.businessId,
		    	executionId:me.executionId,
		    	isPass:isPass
