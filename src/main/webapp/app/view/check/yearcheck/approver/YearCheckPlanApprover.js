...
Ext.define('FHD.view.check.yearcheck.approver.YearCheckPlanApprover', {
    extend: 'Ext.form.Panel',
    alias: 'widget.yearCheckPlanApprover',
		...
		me.flowtaskbar = Ext.widget('panel',{
			...
			items:Ext.create('FHD.ux.icm.common.FlowTaskBar',{
	    		jsonArray:[
		    		...
		    		{index: 2, context:'2.主管领导审批',status:'current'},
		    		{index: 3, context:'3.负责人审批',status:'undo'},
