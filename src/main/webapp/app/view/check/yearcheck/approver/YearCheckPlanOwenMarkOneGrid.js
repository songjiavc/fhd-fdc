 ...
 */
Ext.define('FHD.view.check.yearcheck.approver.YearCheckPlanOwenMarkOneGrid',{
	...
	openCheckView:function (orgId){
		var me = this;
    	me.detailGrild = Ext.create('FHD.view.check.yearcheck.approver.YearCheckPlanOwenDetailGrid', {
			height : 500
		});
