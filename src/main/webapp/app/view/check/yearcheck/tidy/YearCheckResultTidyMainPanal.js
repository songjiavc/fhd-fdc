 ...
 * Date:2017-08-01
 */
 Ext.define('FHD.view.check.yearcheck.tidy.YearCheckResultTidyMainPanal',{
 		extend: 'Ext.form.Panel',
    	alias: 'widget.yearCheckResultTidyMainPanal',
    ...
    initComponent : function() {
		    ...
		    '->',
		    {
				...
				me.yearCheckOwenMarkDownPanal = Ext
						.create(
								'FHD.view.check.yearcheck.tidy.YearCheckResultTidyDownPanal',
								{
									flex : 1,
...
//提交选择审批人
	...
	me.subWinhide(formulateApproverEdit);
		...
		FHD.ajax({//ajax调用
			url : __ctxPath+ '/check/yearcheck/submTidyMark.s',
		    params : {
		    	businessId:me.businessId,
		    	executionId:me.executionId,
		    	isPass:isPass,
