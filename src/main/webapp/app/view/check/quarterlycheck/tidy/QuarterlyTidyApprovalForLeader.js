 ...
 * Date:2017-08-01
 */
 Ext.define('FHD.view.check.quarterlycheck.tidy.QuarterlyTidyApprovalForLeader',{
 		extend: 'Ext.form.Panel',
    	alias: 'widget.quarterlyTidyApprovalForLeader',
...
//提交选择审批人
	...
	var approverId = formulateApproverEdit.items.items[0].value;
	   me.subWinhide(formulateApproverEdit);
		...
		FHD.ajax({//ajax调用
			url : __ctxPath+ '/check/yearcheck/submTidyMarkForLeader.s',
		    params : {
		    	businessId:me.businessId,
		    	executionId:me.executionId,
		    	isPass:isPass,
