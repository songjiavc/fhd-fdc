 ...
 */
Ext.define('FHD.view.check.yearcheck.plan.QuarterlyCheckDownGrid',{
	extend:'FHD.ux.GridPanel',
	alias: 'widget.quarterlyCheckDownGrid',
	requires: [
    ],
	...
	initComponent:function(){
		...
		me.cols=[
        	...
        	{header: '抽查单位', dataIndex: 'orgName', sortable : true, flex: 5 },
        	{header: '抽查单位承办人', dataIndex: 'orgName', sortable : true, flex: 5 },
