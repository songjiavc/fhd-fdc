Ext.define('FHD.view.kpi.bpm.targetgather.KpiTargetResultInput', {
    ...
    initComponent: function () {
        var me = this;
        me.bpmStart = false;
        me.queryUrl = __ctxPath + '/kpi/kpi/showGatherResultList.f';
        me.saveUrl = __ctxPath + '/kpi/kpi/saveGatherResultList.f';
        me.type = 'bpm';
                    ...
                    if ("1" == v) {
                        ...
                        if (str[1] == '0alarm_startus_h') {
                            if (type) {
                                ...
                                memoSpan =  "<imagesrc='"+__ctxPath+"/images/icons/icon_comment_importance_high.gif'   />";
                            }
    ...
    last: function (promptFlag) {
        ...
        for (var i = 0; i < selection.length; i++) {
            ...
            kpi.kpivalue = selection[i].get('targetValue');
            ...
            targetValue = selection[i].get('targetValue'); 
            if(!me.validateInputValue(targetValue,maxValue,minValue,kpiName)) {
            	return false;
            }
            jsobj.push(kpi);
        }
