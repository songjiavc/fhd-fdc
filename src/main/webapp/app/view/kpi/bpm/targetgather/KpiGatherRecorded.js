Ext.define('FHD.view.kpi.bpm.targetgather.KpiGatherRecorded', {
    ...
    initComponent: function () {
        ...
        // 风险评价面板
        if (!me.riskAssess) {
            me.riskAssess = Ext.create('Ext.container.Container', {
                navigatorTitle: '风险评价'
            })
        }
        //风险应对面板
        if (!me.riskReplay) {
            me.riskReplay = Ext.create('Ext.container.Container', {
                navigatorTitle: '风险应对'
            })
        }
