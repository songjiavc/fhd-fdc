Ext.define('FHD.view.kpi.export.strategymap.StrategyMapImportGrid', {
    extend: 'FHD.ux.GridPanel',
    initComponent: function () {
        var me = this;
        var url = __ctxPath + '/sm/import/findinvalidatesmdata.f';
        var tbar = [
            {
                text: "导入数据",
                iconCls: 'icon-save',
    ...
    importData: function () {
        ...
        Ext.Msg.confirm('提示', msg, function (g) {
            if (g == 'yes') {
                FHD.ajax({
                    async: false,
                    url: __ctxPath + '/sm/import/confirmimportsmdata.f?isCoverage='+me.isCoverage,
