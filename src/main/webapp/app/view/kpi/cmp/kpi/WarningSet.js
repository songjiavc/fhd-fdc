 ...
 * @author 陈晓哲
 */
Ext.define('FHD.view.kpi.cmp.kpi.WarningSet', {
        ...
        if (me._validateContent(jsonArray)) {
            ...
            FHD.ajax({
                ...
                params: {
                    ...
                    id: me.pcontainer.kpibasicform.paramObj.kpiId
                },
    ...
    alarmRenderFun: function (value) {
        ...
        return "<div data-qtitle='' data-qtip='" + valuestr + "' id = '" + me.id +"ALARM'>" + valuestr + "</div>";
    },
    ...
    warningRenderFun: function (value) {
        ...
        return "<div data-qtitle='' data-qtip='" + values + "' id ='" + me.id + "WARN'>" + values + "</div>";
    },
    ...
    initComponent: function () {
        ...
        me.on('selectionchange', function(){
        	//删除按钮
        	if(me.down("[name='kpidelBtn']")){
        		me.down("[name='kpidelBtn']").setDisabled(me.getSelectionModel().getSelection().length === 0);
        	}
        }); 
