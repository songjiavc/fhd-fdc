	    		...
	    		if(positionGridPanel.isAdd){//新增保存
	    			if("jg" == treePanel.currentNode.data.type){
	    				...
	    				callback:function(data){
	    					var node = {id:data.data.id,text:data.data.text,iconCls:data.data.iconCls,type:data.data.type,leaf:true};
	    					if(treePanel.currentNode.isExpanded()){
                            ...
                            tabPanel.setActiveTab(1);//新增岗位后，返回机构的下级岗位列表
