Ext.define('FHD.view.sys.st.PlanSelect',{
	 
	hourSelect : function(re, reText, dt){
		//触发时间
	  	dt.allowBlank = true;
	...
	//月选项1
	monthSelect1 : function(re, reText){
		//月不能为空
		//选项1					            	
	...
	//月选项2
	monthSelect2 : function(re, reText){
		//月可以为空
		//选项1					            	
		Ext.getCmp('everyMonth1Id').allowBlank = true;
		Ext.getCmp('everyMonth1Id').regex = null;
	...
	//发送方式
	lookTypeCheck : function(lookTypeDictRadio){
		var count = 0;
	...
	//按周,星期
	weekCheckboxGroupCheck : function(weekCheckboxGroup){
	...
	triggerTypeTimeSelect : function(dt, triggerDataFieldDate, planSelect, radioGroup1){
	...
	triggerTypeAddSelect : function(dt, triggerDataFieldDate, planSelect){
		Ext.getCmp('sf1').hide();
	...
	singleSelect : function(dt, triggerDataFieldDate, planSelect){
		triggerDataFieldDate.show() ;
    	Ext.getCmp('sf1').hide();
    	Ext.getCmp('sf2').hide();
    	//触发时间
	...
	periodSelect : function(dt, triggerDataFieldDate){
