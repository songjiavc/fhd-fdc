...
Ext.define('FHD.view.comm.report.icsystem.ConstructPlanTestReportList', {
	...
	onSave : function(){
		...
		constructplancenterpanel.add(Ext.create('FHD.view.comm.report.icsystem.ConstructTestReportForm'));
	},
	onEdit : function(){
		...
		var constructplancenterpanel = this.up('constructplancenterpanel');
		constructplancenterpanel.removeAll(true);
		var constructtestreportform = Ext.create('FHD.view.comm.report.icsystem.ConstructTestReportForm',{reportId:selection.get('id')});
