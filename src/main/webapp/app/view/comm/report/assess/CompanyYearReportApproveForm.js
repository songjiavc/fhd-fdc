 ...
 * @author 胡迪新
 */
Ext.define('FHD.view.comm.report.assess.CompanyYearReportApproveForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyyearreportapproveform',
    ...
    onSave : function(){
    	...
    	var me = this.up('companyyearreportapproveform');
    	if(me.form.isValid()) {
    		FHD.submit({
				form : me.form,
				params : {
