 ...
 * @author 胡迪新
 */
Ext.define('FHD.view.comm.report.assess.CompanyYearReportForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyyearreportform',
	
    requires: [
    	'FHD.view.comm.report.assess.CompanyYearReportBaseForm',
    ...
    onSave : function(){
    	...
    	var me = this.up('companyyearreportform');
		...
		FHD.submit({
			...
			callback: function (data) {
				...
				centerpanel.add(Ext.widget('companyyearreportlist'));
			}
		});
    },
    /*
    ...
    reloadData : function() {
    	...
    	me.form.load({
            ...
            success: function (form, action) {
            	...
            	//刷新缺陷整改情况列表
            	//me.formPanel.rectifyGrid.store.proxy.extraParams.assessplanId = responseJson.data.assessplanId;
            	//me.formPanel.rectifyGrid.store.load()
            	//刷新缺陷认定汇总列表
