 ...
 * @author 胡迪新
 */
Ext.define('FHD.view.comm.report.assess.CompanyYearReportCompileForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyyearreportcompileform',
    ...
    onSave : function(){
    	...
    	var me = this.up('companyyearreportcompileform');
    	if(me.form.isValid()) {
    		FHD.submit({
				form : me.form,
				params : {
