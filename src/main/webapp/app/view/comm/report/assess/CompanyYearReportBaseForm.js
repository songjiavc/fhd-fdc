Ext.define('FHD.view.comm.report.assess.CompanyYearReportBaseForm', {
	extend : 'Ext.form.Panel',
	alias : 'widget.companyyearreportbaseform',
	...
	initComponent: function(){
		...
		Ext.apply(me,{
			items:[{
	            ...
	            items: [{
	            	...
	            	fieldLabel: '评价计划'+ '<font color=red>*</font>',
	            	name: 'assessplanId',
	            	multiSelect:true,
    	...
    	me.rectifyGrid = Ext.create('FHD.ux.GridPanel',{
    		height:150,
