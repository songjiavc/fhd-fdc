Ext.define('FHD.view.comm.theme.LayoutDataPanel', {
    ...
    save: function () {
    	...
    	me.save_url =__ctxPath+'/ic/theme/savelayoutdetailedset.f';
    	var form = me.getForm();
...
//            },
        ...
        Ext.applyIf(me, {
            buttons: formButtons,
            items : [me.basicfieldSet, gridfieldSet]
        });
...
//	            queryMode: 'local',
	    ...
	    me.chartType.onLoad();
		me.basicfieldSet.add(me.chartType);
		if(!value) return ;
    ...
    addFun:function(){
    	...
    	if(me.chartType.value=='1'){
    		me.selectorWindow1= Ext.create('FHD.ux.kpi.opt.KpiSelectorWindow',{
 			...
 			me.selectorWindow1.addComponent();
    	}
