		...
		function save(){
			...
			Ext.Ajax.request({
				...
				success: function(response) {
					...
					window.top.Ext.ux.Toast.msg('成功', "保存成功");
					var centerPanel = top.Ext.getCmp("center-panel");
					var tab = centerPanel.getComponent("home");
					centerPanel.setActiveTab(tab);
					var home = parent.$('#framehome');
					var url = home.attr("src");
					home.attr("src","");
					home.attr("src",url);
					
				},
				failure: function(response) {
					window.top.Ext.ux.Toast.msg('失败', "保存失败");
				}
			});
