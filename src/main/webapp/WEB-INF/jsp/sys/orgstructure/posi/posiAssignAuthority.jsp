...
<title><spring:message code="fhd.sys.orgstructure.posi.position"/><spring:message code="fhd.sys.auth.authority.assignAuthority"/></title>
<script type="text/javascript">
	function selectCheckbox(idValue){
		...
		$.ajax({
			type: "GET",
			url: "${ctx}/sys/orgstructure/posi/queryAuthorityByPosiAjax.do",
			data: "pid="+idValue,
	...
	function assignAuthority(){
		...
		if(selectIds == null || selectIds == ""){
			...
			$.ajax({
				type: "GET",
				url: "${ctx}/sys/orgstructure/posi/posiAssignAuthoritySubmit.do",
...
<body>
<form id="posiForm" name="posiForm" action="${ctx}/sys/orgstructure/posi/posiAssignAuthoritySubmit.do" method="post">
