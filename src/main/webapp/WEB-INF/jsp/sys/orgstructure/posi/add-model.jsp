...
<body>
	<form:form commandName="posiForm"  method="post">
		<form:hidden path="id"/>
		<input type="hidden" value="${param.id}" id="orgId" name="orgId"/>
		<table id="showTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="fhd_form_table">
			...
			<tr>
				...
				<td colspan="3"><form:textarea path="remark" rows="5" cssStyle="width:592;"></form:textarea>
			</tr>
			<tr>
		...
		$(document).ready(function(){
		    ...
		    $('#submits').click(function(){
				if(true == validator.form()){
					...
					var options = {
						url:'${ctx}/sys/orgstructure/posi/add.do',
						type:'POST',
