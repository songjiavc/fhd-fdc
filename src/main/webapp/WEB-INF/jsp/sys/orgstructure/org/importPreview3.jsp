    ...
    $(document).ready(function(){  
        ...
        function importDatas(btn){
        	if(btn=="yes"){
        		...
        		// 后台操作更新数据
        		ajaxReq('${ctx}/sys/orgstructure/org/importData.do',{importType:'3'},function(response){
        			msgTip.hide();
        	      	if(response == "true"){
...
<table width="100%" id="mytable" cellspacing="0">
		...
		<tr>
			<th align="center" scope="col">职务名称</th>
			<th align="center" scope="col">权重</th>
			<th align="center" scope="col">所属公司</th>
		</tr>
		<c:forEach items="${datas}" var="duty">
		<tr>
				<td class="row" align="left" title="${duty.dutyName}">
				&nbsp;${duty.dutyName}
				</td>
				<td class="row"  align="left" title="${duty.remark}">
				&nbsp;${duty.remark}
				</td>
				<td class="row"  align="left" title="${duty.id}">
				&nbsp;${duty.id}
				</td>
		</tr>
		</c:forEach>
