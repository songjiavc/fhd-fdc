    ...
    $(document).ready(function(){  
        ...
        function importDatas(btn){
        	if(btn=="yes"){
        		...
        		// 后台操作更新数据
        		ajaxReq('${ctx}/sys/orgstructure/org/importData.do',{importType:'1'},function(response){
        			msgTip.hide();
        	      	if(response == "true"){
...
<table width="100%" id="mytable" cellspacing="0">
		...
		<tr>
			<th align="center" scope="col">机构编号</th>
			<th align="center" scope="col">机构名称</th>
			<th align="center" scope="col">上级机构名称</th>
			<th align="center" scope="col">机构类型</th>
			<th align="center" scope="col">部门所属分公司</th>
		</tr>
		<c:forEach items="${datas}" var="org">
		<tr>
				<td class="row" align="left" title="${org.orgname}">
				&nbsp;${org.orgcode}
				</td>
				<td class="row"  align="left" title="${org.orgname}">
				&nbsp;${org.orgname}
		...
		<c:forEach items="${edatas}" var="org">
		<tr class="error">
				<td class="row" align="left" title="${org.impErrorInfo}">
				&nbsp;${org.orgcode}
				</td>
				<td class="row"  align="left" title="${org.impErrorInfo}">
				&nbsp;${org.orgname}
