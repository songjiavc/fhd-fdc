    ...
    $(document).ready(function(){  
        ...
        function importDatas(btn){
        	if(btn=="yes"){
        		...
        		// 后台操作更新数据
        		ajaxReq('${ctx}/sys/orgstructure/org/importData.do',{importType:'2'},function(response){
        			msgTip.hide();
        	      	if(response == "true"){
...
<table width="100%" id="mytable" cellspacing="0">
		<caption> </caption>
		<tr align="center">
			<td colspan="6" style="font:30">数据预览</td>
		</tr>
		<tr>
			<th align="center" scope="col">岗位编号</th>
			<th align="center" scope="col">岗位名称</th>
			<th align="center" scope="col">所属部门</th>
			<th align="center" scope="col">所属公司</th>
		</tr>
		<c:forEach items="${datas}" var="pos">
		<tr>
				<td class="row" align="left" title="${pos.posicode}">
				&nbsp;${pos.posicode}
				</td>
				<td class="row"  align="left" title="${pos.posiname}">
				&nbsp;${pos.posiname}
				</td>
				<td class="row"  align="left" title="${pos.posiStatus}">
				&nbsp;${pos.posiStatus}
				</td>
				<td class="row"  align="left" title="${pos.remark}">
				&nbsp;${pos.remark}
				</td>
		</tr>
		</c:forEach>
		<c:forEach items="${edatas}" var="pos">
		<tr class="error">
				<td class="row" align="left" title="${pos.impErrorInfo}">
				&nbsp;${pos.posicode}
				</td>
				<td class="row"  align="left" title="${pos.impErrorInfo}">
				&nbsp;${pos.posiname}
