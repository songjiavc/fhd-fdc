...
<form:form commandName="empForm" action="" method="post">
	<input type="hidden" id="orgId" name="orgId" value="${id}"/>
	<input type="hidden" id="positionId" name="positionId" value="${empForm.positionId}"/>
	<table id="showTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="fhd_form_table">
		...
		<table id="showUserTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="fhd_form_table" style="display:none;">
			...
			<tr>
				...
				<td><form:input path="password" /><font color="red">*</font></td>
				<th><spring:message code="fhd.common.status"/>：</th>
				<td>
					<form:select path="userStatus" >
						<option value=""><spring:message code="fhd.common.pleaseSelect"/></option>
						<option value='<spring:message code="fhd.common.normal"/>'><spring:message code="fhd.common.normal"/></option>
						<option value='<spring:message code="fhd.common.cancellation"/>'><spring:message code="fhd.common.cancellation"/></option>
					</form:select><font color="red">*</font>
				</td>
			</tr>
			<tr>
				...
				<td>
					<form:select path="lockstate" >
						<option value=""><spring:message code="fhd.common.pleaseSelect"/></option>
						<option value="1"><spring:message code="fhd.common.notLocked"/></option>
						<option value="0"><spring:message code="fhd.common.lock"/></option>
					</form:select>
				</td>
			...
			<!-- 
			<tr>
				<th><spring:message code="fhd.common.portal"/>：</th>
				<td>
					<form:select path="portal">
						<option value=""><spring:message code="fhd.common.pleaseSelect"/></option>
						<option value="1" <c:if test="${empForm.lockstate eq '1' }">selected="selected"</c:if>><spring:message code="fhd.common.true"/></option>
					</form:select>
				</td>
				<th>&nbsp;</th>
				<td>&nbsp;</td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="fhd_form_table">
			<tr>
				<th colspan="4" align="center">
					...
					<input id="close" name="close" type="button" value="取消" class="fhd_btn"/>
				</th>
			</tr>
		</table>
</form:form>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(true == validator.form()){
			...
			var options = {
				url:'${ctx}/sys/orgstructure/emp/add.do',
				type:'POST',
