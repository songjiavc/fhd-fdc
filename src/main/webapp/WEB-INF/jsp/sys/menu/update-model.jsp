...
<head>
	...
	<title><spring:message code="editorg"/></title>
</head>
<body onload="load();"> 
	<form:form commandName="menuForm" action="" method="post">
		<input type="hidden" name="parentId" value="${menuForm.parentId }"/>
		<form:hidden path="id" />
		...
		<table id="showTable" width="100%"  border="0" cellpadding="0" cellspacing="0" class="fhd_form_table">
			...
			<tr>
				<th colspan="2" align="center">
					<input id="submits" type="button" name="submit" value="<spring:message code="save_btn" />" class="fhd_btn" />&nbsp;&nbsp;
	...
	<script type="text/javascript">
		function popWindows(){
			FHD.openWindow('选择功能点', 800, 500, '${ctx}/sys/auth/functionList.do','no');
		}
