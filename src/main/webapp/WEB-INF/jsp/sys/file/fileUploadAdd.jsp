	...
	<form:form commandName="fileUploadForm" method="post" enctype="multipart/form-data">
		<table id="showTable" width="100%" border="0" cellpadding="0"
			...
			<tr>
				...
				<td><input type="file" size="28" name="file"
					style="width: 300px" onkeydown="'this.blur();'" /></td>
			</tr>
			<tr>
				<th><spring:message code="fhd.sys.file.newFileName" />：</th>
				<td><input type="text" size="30" name="aliasName"
					style="width: 300px" /></td>
			</tr>
			<tr>
				<th><spring:message code="fhd.sys.file.chooseWay" />：</th>
				<td><form:select path="chooseWay" cssClass="required"
			...
			<tr>
				...
				<td><textarea name="notes" cols="1" rows="2"
					style="width: 300px"></textarea></td>
			</tr>
			<tr align="center">
				<td colspan="2" class="fhd_form_bottom"><input type="button" id="submits" name="submits"
					value="<spring:message code="fhd.common.submit"/>" class="fhd_btn" />
				&nbsp;&nbsp; <input type="reset"
					value="<spring:message code="fhd.common.reset"/>" class="fhd_btn" /></td>
			</tr>
		</table><b>允许上传文件类型：
		"jpg", "jpeg", "gif", "txt", "doc", "mp3", "wma", "m4a", "rar", "zip", "xls"
		</b>
	</form:form>
	<script type="text/javascript">
		$(document).ready(function(){
		    ...
		    $('#submits').click(function(){
		        ...
		        var options={
		        url:'${ctx}/sys/file/fileUploadSave.do',
		        type:'post',
