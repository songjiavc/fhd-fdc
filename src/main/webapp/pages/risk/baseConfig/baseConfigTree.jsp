	    	...
	    	itemclick:function(view,node){
	    		...
	    		switch (node.data.text){
		    		...
		    		case FHD.locale.get('fhd.risk.baseconfig.weightConfig'):
		    			initDemoPanel('pages/risk/baseConfig/weightSet.jsp');
	    				break;
		    		case '公式计算':
		    			initDemoPanel('pages/risk/baseConfig/FormulateCalculate.jsp');
	    				break;
		    		//  case '缺陷认定':
		    		//	initDemoPanel('pages/risk/baseConfig/holddefect.jsp');
	    			//	break;
	    			default:
	    				initDemoPanel('暂无');
	    		}
