	    ...
	    valueField: 'id',listeners:
              ...
              select:function(c,r,i){ 
				if(c.value=='st_trigger_type_time'){
					planSelect.triggerTypeTimeSelect();
				}else{
					planSelect.triggerTypeAddSelect();
				}
			 }
              },
	    triggerAction :'all'
	        ...
	        click: {
	            ...
	            fn: function(){
	            	...
	            	if(radioGroup1.items.items[0].checked){
	            		planSelect.singleSelect();
		            }else{
		            	planSelect.periodSelect();
	            	}
	             }
	        }
	    }
...
Ext.onReady(function() {
	...
	formPanel = Ext.create('Ext.form.Panel',{
			...
			text: FHD.locale.get('fhd.common.save'),
				handler:function(){
					var form = formPanel.getForm();
						if(form.isValid()){
							if(!isAdd){
								if(planSelect.weekCheckboxGroupCheck()){
									if(planSelect.lookTypeCheck()){
										//更新
										FHD.submit({
											form:form,
											url:planEdit_saveUrl + '?id=' + param.id,
		...
		planEditPanel = Ext.create('Ext.panel.Panel',{
		    renderTo: 'planEdit${param._dc}', 
