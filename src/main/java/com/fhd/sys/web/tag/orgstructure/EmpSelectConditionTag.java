...
public class EmpSelectConditionTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		EmployeeDAO employeeDAO = (EmployeeDAO) webApplicationContext.getBean("sysEmployeeDAO");
		EmployeeBO employeeBO = (EmployeeBO) webApplicationContext.getBean("empolyeeBO");
