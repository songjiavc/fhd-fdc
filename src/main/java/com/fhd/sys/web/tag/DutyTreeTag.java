 ...
 * @version  
 * @since    Ver 1.1
 * @Date	 2012-2-23		下午03:58:16
 *
 * @see 	 
 */
public class DutyTreeTag extends TagSupport {
	...
	private String sbEmptyText = "查找职务";//查询框默认文本
	...
	public int doStartTag() throws JspException {
		...
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(
				    ((DutyTreeTag.class.getResourceAsStream("/component_vm/SearchTreeTag.vm")))));
