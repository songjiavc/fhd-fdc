...
public class AuthorityLabelTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			AuthorityBO sysAuthorityBean = (AuthorityBO) webApplicationContext.getBean("sysAuthorityBO");
