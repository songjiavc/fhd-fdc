...
/**
 * ClassName:OrgSelector Function: ENDO ADD FUNCTION Reason: ENDO ADD REASON
 * 
 * @author David.Niu
 * @version
 * @since Ver 1.1
...
public class EmpSelectorTag2 extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		RoleBO o_sysRoleBO = (RoleBO) webApplicationContext.getBean("sysRoleBO");
		EmployeeBO o_empolyeeBO = (EmployeeBO) webApplicationContext.getBean("empolyeeBO");
		...
		//WebApplicationContext webApplicationContext = WebApplicationContextUtils.getWebApplicationContext(pageContext.getServletContext());
		EmployeeDAO empEntryBean = (EmployeeDAO) webApplicationContext.getBean("sysEmployeeDAO");
