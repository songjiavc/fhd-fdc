...
public class OrganizationForm extends SysOrganization{
	...
	private String parentNameSeq;//上级机构名称
	...
	public  OrganizationForm(SysOrganization org){
		...
		if(null != org.getParentOrg()){
			...
			this.setParentNameSeq(org.getParentOrg().getNameSeq());
		}else{
			this.setOrgLevel(1);
		}
		//this.setOrgLevel(org.getOrgLevel());
		
		this.setNameSeq(org.getNameSeq());
	...
	public String getParentNameSeq() {
		return parentNameSeq;
	}

	public void setParentNameSeq(String parentNameSeq) {
		this.parentNameSeq = parentNameSeq;
	}
