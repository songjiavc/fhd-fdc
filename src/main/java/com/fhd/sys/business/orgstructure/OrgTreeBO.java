...
public class OrgTreeBO {
	 ...
	 * @since  fhd　Ver 1.1
	*/
	public List<Map<String, Object>> deptTreeLoader(Boolean checkable, String id,Boolean subCompany,String chooseId,String searchName,Boolean companyOnly,Boolean showLight,String schm){
		List<Map<String, Object>> nodes = new ArrayList<Map<String, Object>>();
		...
		if(showLight){
			...
			orgMap = o_riskOutsideBO.findRiskAssementStatusById("org", ids);
		}
		...
		for (SysOrganization org : organizations) {
			...
			node.put("cls", "org");
			if(showLight){
				node.put("iconCls", orgMap.get(org.getId()).toString());
			}
			nodes.add(node);
		}
		return nodes;
	...
	*/
	 ...
	 * @since  fhd　Ver 1.1
	*/
	public List<Map<String, Object>> kpiDeptTreeLoader(Boolean checkable, String id,Boolean subCompany,String chooseId,String searchName,Boolean companyOnly){
		List<Map<String, Object>> nodes = new ArrayList<Map<String, Object>>();
		Criteria criteria = o_sysOrgDAO.createCriteria();
		criteria.add(Restrictions.eq("deleteStatus", Contents.DELETE_STATUS_USEFUL));
		String[] orgType = null;
