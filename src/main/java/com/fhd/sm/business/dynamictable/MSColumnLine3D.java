...
public class MSColumnLine3D {
	...
	public static String getXml(String title, String title2,
			List<KpiGatherResult> list, Map<String, TimePeriod> map) {
		StringBuffer xml = new StringBuffer();
		String name = "";
		
		xml.append("<chart showValues='0' bgColor='ffffff' animation='0' showBorder='0' canvasbgColor='ffffff' canvasbgAlpha='0' canvasBaseDepth='1' chartBottomMargin='20' ");
		xml.append("baseFontSize='10'  legendPosition='right'   ");
	...
	public static String getTitleXml(String title,List<KpiGatherResult> list, Map<String, TimePeriod> map) {
		StringBuffer xml = new StringBuffer();
		String name = "";
		...
		xml.append("legendBgColor='ffffff' legendShadow='0' legendBorderColor='ffffff' placeValuesInside='0'caption='"+title+"'>");
