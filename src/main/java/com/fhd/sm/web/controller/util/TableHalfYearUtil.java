...
//		add by haojing  备注信息列
	...
	public static String getHalfYearHtml(String contextPath, String yearId, boolean isEdit, String kpiId, String timeId,
		...
		//实际
		String inputReality = "<input type='text' value='" + realityValue + "' name='" + inputId + "reality' id='"+ containerId+ inputName + "reality' class='tableTextInputChanged' style='font-size: 100%;'>";
		//目标
		String inputTarget = "<input type='text' value='" + targetValue + "' name='" + inputId + "target' id='" + containerId + inputName + "target' class='tableTextInputChanged' style='font-size: 100%;'>";
		//评估
		String inpuAssess = "<input type='text' value='" + assessValue + "' name='" + inputId + "assess' id='" + containerId + inputName + "assess' class='tableTextInputChanged' style='font-size: 100%;'>";
...
//		add by haojing  备注信息列
		String memoStr = "注释——"+memoKpiName+"("+yearId+"年)";
...
//		add by haojing  备注信息列
		quarterHtml.append("<td nowrap='true' align='center' class='normalTabLevel3' hi='3'>" + inputReality + "</td>\n");
		quarterHtml.append("<td nowrap='true' align='center' class='normalTabLevel3' hi='3'>" + inputTarget + "</td>\n");
		quarterHtml.append("<td nowrap='true' align='center' class='normalTabLevel3' hi='3'>" + inpuAssess + "</td>\n");
