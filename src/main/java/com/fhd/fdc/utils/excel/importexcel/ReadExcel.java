...
//			Cell[] cells = sheet.getRow(i);
	 ...
	 * @since  fhd　Ver 1.1
	 */
	public List<List<String>> readEspecialExcel(InputStream excelInputStream,int sheetNo) throws Exception{
		/**
		 * 返回值
		 */
		List<List<String>> excelDatas = new ArrayList<List<String>>();
...
//			Cell[] cells = sheet.getRow(i);
	 ...
	 * @since  fhd　Ver 1.1
	 */
	public List<List<String>> readEspecialExcel(InputStream excelInputStream,String sheetName) throws Exception{
		/**
		 * 返回值
		 */
		List<List<String>> excelDatas = new ArrayList<List<String>>();
...
//		InputStream excelInputStream = new FileInputStream(excelPath);
	 ...
	 * @since  fhd　Ver 1.1
	 */
	public List<List<String>> readEspecialExcel(InputStream excelInputStream, int sheetNo, int rowNumber) throws Exception{
		/**
		 * 返回值
		 */
		List<List<String>> excelDatas = new ArrayList<List<String>>();
