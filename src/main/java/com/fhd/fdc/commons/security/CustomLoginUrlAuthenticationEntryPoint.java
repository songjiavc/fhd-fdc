...
/**
 * 自定义登录url处理--解决sendRedirect后ssoLogin.do获取不到原参数问题.
 * @author 吴德福
 * @Date 2013-11-01 17:28:21
 */
public class CustomLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
        ...
        if (useForward) {
    		...
    		redirectUrl = redirectUrl+"?businessId="+businessId+"&taskId="+taskId+"&url="+url+"&loginType="+loginType+"&username="+username;
        }
