...
//				}
				...
				if(!((constructPlanForm.getGroupLeaderId().equals(constructPlanForm.getGroupLeaderIdHid()))&&constructPlanForm.getGroupPersId().equals(constructPlanForm.getGroupPersIdHid()))){
					Criteria craConstructPlanRelaOrg = o_constructPlanRelaOrgDAO.createCriteria();
					craConstructPlanRelaOrg.add(Restrictions.eq("constructPlan.id", constructPlanForm.getId()));
					List<ConstructPlanRelaOrg> orgList = craConstructPlanRelaOrg.list();
	...
	public ConstructPlan findConstructPlanById(String constructPlanId) {
		return o_constructPlanDAO.get(constructPlanId);
	}
