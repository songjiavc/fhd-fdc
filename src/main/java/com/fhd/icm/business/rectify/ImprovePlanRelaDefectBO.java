...
import com.fhd.dao.icm.rectify.ImprovePlanRelaDefectDAO;
...
public class ImprovePlanRelaDefectBO {
	...
	*/
	 ...
	 * @return List<Object[]>
	 */
	public List<Object[]> findDefectImproveInfoByAssessplanId(String assessplanIds,String query){
		...
		*/
		...
		if(StringUtils.isNotBlank(query)){
			sqlBuffer.append("and td.edesc like '%"+query+"%' ");
		}
