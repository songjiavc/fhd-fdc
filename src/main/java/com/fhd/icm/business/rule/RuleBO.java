...
import com.fhd.dao.icm.rule.RuleDAO;
import com.fhd.dao.icm.rule.RuleRelaFileDAO;
import com.fhd.dao.icm.rule.RuleRelaOrgDAO;
import com.fhd.entity.icm.rule.Rule;
import com.fhd.entity.icm.rule.RuleRelaFile;
import com.fhd.entity.icm.rule.RuleRelaOrg;
	...
	public Map<String, Object> findRuleByID(String ruleID,String ruleParentId) {
		...
		if(null != fileList && fileList.size()>0){
			...
			for(RuleRelaFile ruleRalaFile:fileList){
				fileIds.append(ruleRalaFile.getFile().getId());
