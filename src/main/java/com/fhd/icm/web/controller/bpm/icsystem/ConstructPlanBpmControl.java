...
public class ConstructPlanBpmControl {
	...
	public Map<String,Object> constructPlanRelaProcessSubmit(String executionId, String businessId) {
		return o_constructPlanBpmBO.constructPlanRelaProcessSubmit(executionId, businessId);
	}
	/**
	 * 建设计划流程梳理成果审批.
	 * @param executionId 流程id
	...
	public Map<String,Object> constructPlanResultsRepair(String executionId, String businessId) {
		return o_constructPlanBpmBO.constructPlanResultsRepair(executionId, businessId);
	}
	/**
	 * 合规诊断任务提交
	 * @param executionId 流程id
