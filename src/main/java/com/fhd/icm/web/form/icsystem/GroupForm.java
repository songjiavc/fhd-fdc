...
public  class GroupForm{
	...
	public String getDefectFormstr() {
		return defectFormstr;
	}
	public void setDefectFormstr(String defectFormstr) {
		this.defectFormstr = defectFormstr;
	}
