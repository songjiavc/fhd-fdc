...
public class IcmStandardUtils {
	...
	public static String findIdbyJason(String jasonStr, String findParam) {
		StringBuilder returnFindParams = new StringBuilder();
		if (StringUtils.isNotEmpty(jasonStr)) {
			...
			for (int i = 0; i < jsonArrayLength; i++) {
				...
				returnFindParams.append(jsonObject.getString(findParam));
				if(i!=jsonArrayLength-1){
					returnFindParams.append(",");
				}
			}
		}
		return returnFindParams.toString();
	}
}