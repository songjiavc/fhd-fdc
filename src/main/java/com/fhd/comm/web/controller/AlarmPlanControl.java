...
public class AlarmPlanControl
{
    ...
    */
    ...
    public Map<String, Object> findRiskAlarmPlan() throws Exception
    {
        ...
        {
    		AlarmPlanForm form = new AlarmPlanForm(alarmPlan);
            datas.add(form);
        }
    ...
    */
    ...
    {
        Map<String, Object> result = new HashMap<String, Object>();
        JSONObject  objValues = JSONObject.fromObject(request.getParameter("values"));
        
        form.setDescs(objValues.getString("descs"));
        form.setId(objValues.getString("id"));
        form.setRange(objValues.getString("range"));
        form.setName(objValues.getString("name"));
        form.setTypes(objValues.getString("types"));
    ...
    */
    ...
    public Map<String, Object> mergeAlarmPlan(AlarmPlanForm form, String params,HttpServletRequest request)
    {
        Map<String, Object> result = new HashMap<String, Object>();
        JSONObject  objValues = JSONObject.fromObject(request.getParameter("values"));
