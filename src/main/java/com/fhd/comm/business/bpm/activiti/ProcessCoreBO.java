 ...
 * @author 胡迪新
 * @since fhd Ver 4.5
 * @Date 2013-2-17 上午11:23:43
 * 
 * @see
 */

public class ProcessCoreBO {
	
	protected RepositoryService o_repositoryService;

	protected RuntimeService o_runtimeService;

	protected TaskService o_taskService;

	protected FormService o_formService;

	protected HistoryService o_historyService;
	
	protected ProcessOtherBO o_processOtherBO;
	...
	public List<ActivityImpl> findBackAvtivity(String taskId) throws Exception {
		...
		if (o_processOtherBO.isJointTask(taskId)) {// 会签任务节点，不允许驳回
	...
	public void passProcess(String taskId, Map<String, Object> variables)
			throws Exception {
		List<Task> tasks = o_taskService.createTaskQuery().taskId(taskId)
				.taskDescription("jointProcess").list(); // 修改不知道对不对
	...
	public void jointProcess(String taskId, List<String> userCodes)
		...
		for (String userCode : userCodes) {
			TaskEntity task = (TaskEntity) o_taskService.newTask();
	...
	public void transferAssignee(String taskId, String userCode) {
		o_taskService.setAssignee(taskId, userCode);
	}
	...
	private void commitProcess(String taskId, Map<String, Object> variables,
		...
		// 跳转节点为空，默认提交操作
		if (StringUtils.isEmpty(activityId)) {
			o_taskService.complete(taskId, variables);
		} else {// 流程转向操作
	...
	private HistoricActivityInstance findHistoricUserTask(
		...
		// 查询当前流程实例审批结束的历史节点
		List<HistoricActivityInstance> historicActivityInstances = o_historyService
	...
	public void setFormService(FormService formService) {
		this.o_formService = formService;
	}

	public void setHistoryService(HistoryService historyService) {
		this.o_historyService = historyService;
	}

	public void setRepositoryService(RepositoryService repositoryService) {
		this.o_repositoryService = repositoryService;
	}

	public void setRuntimeService(RuntimeService runtimeService) {
		this.o_runtimeService = runtimeService;
	}

	public void setTaskService(TaskService taskService) {
		this.o_taskService = taskService;
	}
	...
	private TaskEntity findTaskById(String taskId) throws Exception {
		TaskEntity task = (TaskEntity) o_taskService.createTaskQuery()
	...
	private List<Task> findTaskListByKey(String processInstanceId, String key) {
		return o_taskService.createTaskQuery()
	...
	private ProcessInstance findProcessInstanceByTaskId(String taskId)
			throws Exception {
		// 找到流程实例
		ProcessInstance processInstance = o_runtimeService
	...
	private ProcessDefinitionEntity findProcessDefinitionEntityByTaskId(
		...
		// 取得流程定义
		ProcessDefinitionEntity processDefinition = (ProcessDefinitionEntity) ((RepositoryServiceImpl) o_repositoryService)
